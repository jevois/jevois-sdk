...
function check_env()
{
    ...
    mk_info "CHIP: ${LICHEE_CHIP} PLATFORM: ${LICHEE_PLATFORM} KERN: ${LICHEE_KERN_VER} BOARD: ${LICHEE_BOARD}"
}
...
function mkrootfs()
{
	...
	# JEVOIS: we do not need this with new buildroot???
