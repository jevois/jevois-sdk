				...
				case 0xf0:			//自定义命令，用于烧录用户数据
	  				...
	  				switch(cbw->CBWCDB[1])
	  				{
						...
						case 1:				//小机端接收数据
						{
                            ...
                            sunxi_usb_pburn_write_enable = 0;
							sunxi_udc_start_recv_by_dma((uint)private_data_ext_buff_step, trans_data.recv_size);
	  			...
	  			case 0xf3:			//自定义命令，用于烧录用户数据
	  				...
	  				switch(cbw->CBWCDB[1])
	  				{
						...
						case 1:				//小机端接收数据
						{
                          pburn_flash_start    = 0;////*(int *)(cbw->CBWCDB + 4);
                            ...
                            sunxi_usb_pburn_write_enable = 0;
							sunxi_udc_start_recv_by_dma(trans_data.act_recv_buffer, trans_data.recv_size);
						...
						case 3:             //小机端发送数据
						{
							...
							start   = 0;////*(int *)(cbw->CBWCDB + 4);		//读数据的偏移量
							sectors = 0;////*(int *)(cbw->CBWCDB + 8);		//扇区数;
