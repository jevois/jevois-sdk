...
int sunxi_usb_init (int delaytime)
{
  ...
  usb_recv_by_dma.cfg.src_drq_type     = DMAC_CFG_TYPE_OTG_EP2; 
  ...
  usb_recv_by_dma.cfg.dst_drq_type     = DMAC_CFG_TYPE_DRAM; 
  ...
  usb_recv_by_dma.pgstp  = 0;
  usb_recv_by_dma.cmt_blk_cnt = 0;
  usb_send_by_dma.cfg.src_drq_type     = DMAC_CFG_TYPE_DRAM; 
  ...
  usb_send_by_dma.cfg.dst_drq_type     = DMAC_CFG_TYPE_OTG_EP1; 
