...
__s32 NAND_DMAConfigStart (int rw, unsigned int buff_addr, int len)
{
  ...
  if (rw)
  {
    if (buff_addr & 0xC0000000)
    { dma_param.src_drq_type = CSP_DMAC_CFG_SRC_TYPE_D_SDRAM; }
    else 
    { dma_param.src_drq_type = CSP_DMAC_CFG_SRC_TYPE_D_SRAM; }
    dma_param.src_addr_type = CSP_DMAC_CFG_SRC_ADDR_TYPE_LINEAR_MODE; 
    dma_param.src_burst_length = CSP_DMAC_CFG_SRC_4_BURST; 
    dma_param.src_data_width = CSP_DMAC_CFG_SRC_DATA_WIDTH_32BIT; 
    
    dma_param.dst_drq_type = CSP_DMAC_CFG_DEST_TYPE_NFC;
    dma_param.dst_addr_type = CSP_DMAC_CFG_DEST_ADDR_TYPE_IO_MODE;
    dma_param.dst_burst_length = CSP_DMAC_CFG_DEST_4_BURST;
    dma_param.dst_data_width = CSP_DMAC_CFG_DEST_DATA_WIDTH_32BIT;
    
    dma_param.wait_state = CSP_DMAC_CFG_WAIT_1_DMA_CLOCK;
    dma_param.continuous_mode = CSP_DMAC_CFG_CONTINUOUS_DISABLE;
    
    dma_param.cmt_blk_cnt =  0x7f077f07;
    
  }
  else
  {
    dma_param.src_drq_type = CSP_DMAC_CFG_SRC_TYPE_NFC;
    dma_param.src_addr_type = CSP_DMAC_CFG_SRC_ADDR_TYPE_IO_MODE; 
    dma_param.src_burst_length = CSP_DMAC_CFG_SRC_4_BURST; 
    dma_param.src_data_width = CSP_DMAC_CFG_SRC_DATA_WIDTH_32BIT; 
    ...
    dma_param.dst_addr_type = CSP_DMAC_CFG_DEST_ADDR_TYPE_LINEAR_MODE;
    dma_param.dst_burst_length = CSP_DMAC_CFG_DEST_4_BURST;
    dma_param.dst_data_width = CSP_DMAC_CFG_DEST_DATA_WIDTH_32BIT;
