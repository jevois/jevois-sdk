...
#define CONFIG_SYS_INIT_RAM_SIZE	     (60*1024)
...
* define const value
*/
#define BOOT_USB_DETECT_DELAY_TIME       (10)
...
#define CONFIG_SYS_PROMPT		"jevois#"
...
#define CONFIG_IDENT_STRING			" JeVois "
...
#define CONFIG_EXTRA_ENV_SETTINGS               \
	...
	"init=/init\0" \
	"loglevel=1\0" \
	"loadbootenv=fatload mmc 0 0x44000000 uEnv.txt\0" \
	"loaduenv=if run loadbootenv; then env import -t 0x44000000 ${filesize}; fi\0" \
    "bootargs=earlyprintk=ttyS0,115200 loglevel=1 initcall_debug=0 console=ttyS0,115200 init=/init rootfstype=ext4 root=/dev/mmcblk0p2 rootwait\0" \
    "bootcmd=run loaduenv; fatload mmc 0 0x43000000 script.bin && fatload mmc 0 0x40007800 uImage && bootm 0x40007800\0"

#define CONFIG_ENV_IS_IN_MMC
#undef CONFIG_ENV_IS_IN_NAND_SUNXI
...
#define CONFIG_BOOTCOMMAND "run loaduenv; fatload mmc 0 0x43000000 script.bin && fatload mmc 0 0x40007800 uImage && bootm 0x40007800"
#define CONFIG_CMDLINE_TAG
