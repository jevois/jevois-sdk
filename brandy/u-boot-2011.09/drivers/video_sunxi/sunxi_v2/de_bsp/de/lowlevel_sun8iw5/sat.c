...
{
  0x0400, 0x0000, 0x064D, 0xF366, 0x0400, 0xFFFFFF41, 0xFFFFFE21, 0x053D, 0x0400, 0x076D, 0x0000, 0xF127,
...
__s32 SAT_Set_Sync_Para (__u32 sel)
{
  ...
  if (enable_flag[sel] == 1)
  {
    ...
    if (sac_num > threshold_A)
    {
      ...
      if (sac_num > threshold_B && sac_num <= threshold_A)
      {
        for (i = 0; i < 64; i++)
        {
        ...
        if (sac_num > threshold_C && sac_num <= threshold_B)
        {
          for (i = 0; i < 64; i++)
          {
