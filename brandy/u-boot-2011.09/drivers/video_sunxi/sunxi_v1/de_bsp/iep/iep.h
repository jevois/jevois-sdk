...
extern __s32 IEP_Drc_Set_Winodw (__u32 sel, __disp_rect_t window);
extern __s32 IEP_Drc_Set_Mode (__u32 sel, __iep_drc_mode_t mode);
extern __s32 iep_drc_early_suspend (__u32 sel);
extern __s32 iep_drc_suspend (__u32 sel);
extern __s32 iep_drc_resume (__u32 sel);//restore register
extern __s32 iep_drc_late_resume (__u32 sel);
...
extern __s32 iep_deu_early_suspend (__u32 sel);
extern __s32 iep_deu_suspend (__u32 sel);
extern __s32 iep_deu_resume (__u32 sel);//restore register
extern __s32 iep_deu_late_resume (__u32 sel);
