...
static __s32 dsi_dphy_cfg_hsfrq (__u32 sel, __u32 hs_frq)
{
  ...
  if     ( (hs_frq_tmp >=   80) && (hs_frq_tmp <  90) ) { hs_frq_set = 0x00; } 
    ...
    if ( (hs_frq_tmp >=   90) && (hs_frq_tmp < 100) )   { hs_frq_set = 0x10; }
    else
      if ( (hs_frq_tmp >=  100) && (hs_frq_tmp < 110) )   { hs_frq_set = 0x20; }
      else
        if ( (hs_frq_tmp >=  110) && (hs_frq_tmp < 130) )   { hs_frq_set = 0x01; }
        else
          if ( (hs_frq_tmp >=  130) && (hs_frq_tmp < 140) )   { hs_frq_set = 0x11; }
          else
            if ( (hs_frq_tmp >=  140) && (hs_frq_tmp < 150) )   { hs_frq_set = 0x21; }
            else
              if ( (hs_frq_tmp >=  150) && (hs_frq_tmp < 170) )   { hs_frq_set = 0x02; }
              else
                if ( (hs_frq_tmp >=  170) && (hs_frq_tmp < 180) )   { hs_frq_set = 0x12; }
                else
                  if ( (hs_frq_tmp >=  180) && (hs_frq_tmp < 200) )   { hs_frq_set = 0x22; }
                  else
                    if ( (hs_frq_tmp >=  200) && (hs_frq_tmp < 220) )   { hs_frq_set = 0x03; }
                    else
                      if ( (hs_frq_tmp >=  220) && (hs_frq_tmp < 240) )   { hs_frq_set = 0x13; }
                      else
                        if ( (hs_frq_tmp >=  240) && (hs_frq_tmp < 250) )   { hs_frq_set = 0x23; }
                        else
                          if ( (hs_frq_tmp >=  250) && (hs_frq_tmp < 270) )   { hs_frq_set = 0x04; }
                          else
                            if ( (hs_frq_tmp >=  270) && (hs_frq_tmp < 300) )   { hs_frq_set = 0x14; }
                            else
                              if ( (hs_frq_tmp >=  300) && (hs_frq_tmp < 330) )   { hs_frq_set = 0x05; }
                              else
                                if ( (hs_frq_tmp >=  330) && (hs_frq_tmp < 360) )   { hs_frq_set = 0x15; }
                                else
                                  if ( (hs_frq_tmp >=  360) && (hs_frq_tmp < 400) )   { hs_frq_set = 0x25; }
                                  else
                                    if ( (hs_frq_tmp >=  400) && (hs_frq_tmp < 450) )   { hs_frq_set = 0x06; }
                                    else
                                      if ( (hs_frq_tmp >=  450) && (hs_frq_tmp < 500) )   { hs_frq_set = 0x16; }
                                      else
                                        if ( (hs_frq_tmp >=  500) && (hs_frq_tmp < 550) )   { hs_frq_set = 0x07; }
                                        else
                                          if ( (hs_frq_tmp >=  550) && (hs_frq_tmp < 600) )   { hs_frq_set = 0x17; }
                                          else
                                            if ( (hs_frq_tmp >=  600) && (hs_frq_tmp < 650) )   { hs_frq_set = 0x08; }
                                            else
                                              if ( (hs_frq_tmp >=  650) && (hs_frq_tmp < 700) )   { hs_frq_set = 0x18; }
                                              else
                                                if ( (hs_frq_tmp >=  700) && (hs_frq_tmp < 750) )   { hs_frq_set = 0x09; }
                                                else
                                                  if ( (hs_frq_tmp >=  750) && (hs_frq_tmp < 800) )   { hs_frq_set = 0x19; }
                                                  else
                                                    if ( (hs_frq_tmp >=  800) && (hs_frq_tmp < 850) )   { hs_frq_set = 0x29; }
                                                    else
                                                      if ( (hs_frq_tmp >=  850) && (hs_frq_tmp < 900) )   { hs_frq_set = 0x39; }
                                                      else
                                                        if ( (hs_frq_tmp >=  900) && (hs_frq_tmp < 950) )   { hs_frq_set = 0x0a; }
                                                        else
                                                          if ( (hs_frq_tmp >=  950) && (hs_frq_tmp < 1000) )   { hs_frq_set = 0x1a; }
                                                          else
                                                            if ( (hs_frq_tmp >= 1000) && (hs_frq_tmp < 1050) )   { hs_frq_set = 0x2a; }
                                                            else
                                                              if ( (hs_frq_tmp >= 1050) && (hs_frq_tmp < 1100) )   { hs_frq_set = 0x3a; }
                                                              else
                                                                if ( (hs_frq_tmp >= 1100) && (hs_frq_tmp < 1150) )   { hs_frq_set = 0x0b; }
                                                                else
                                                                  if ( (hs_frq_tmp >= 1150) && (hs_frq_tmp < 1200) )   { hs_frq_set = 0x1b; }
                                                                  else
                                                                    if ( (hs_frq_tmp >= 1200) && (hs_frq_tmp < 1250) )   { hs_frq_set = 0x2b; }
                                                                    else
                                                                      if ( (hs_frq_tmp >= 1250) && (hs_frq_tmp < 1300) )   { hs_frq_set = 0x3b; }
                                                                      else
                                                                        if ( (hs_frq_tmp >= 1300) && (hs_frq_tmp < 1350) )   { hs_frq_set = 0x0c; }
                                                                        else
                                                                          if ( (hs_frq_tmp >= 1350) && (hs_frq_tmp < 1400) )   { hs_frq_set = 0x1c; }
                                                                          else
                                                                            if ( (hs_frq_tmp >= 1400) && (hs_frq_tmp < 1450) )   { hs_frq_set = 0x2c; }
                                                                            else
                                                                              if ( (hs_frq_tmp >= 1450) && (hs_frq_tmp < 1500) )   { hs_frq_set = 0x3c; }
...
static __s32 dsi_packet_cfg (__u32 sel, disp_panel_para * panel)
{
  ...
  else
  {
    ...
    dsi_dev[sel]->dsi_vid_tim3.bits.hsa             = hspw      * dsi_bits_per_pixel[format] / (8 * lane);
    dsi_dev[sel]->dsi_vid_tim3.bits.hbp             = (hbp - hspw) * dsi_bits_per_pixel[format] / (8 * lane);
