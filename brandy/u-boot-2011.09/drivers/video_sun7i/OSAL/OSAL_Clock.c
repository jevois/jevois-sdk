...
__s32 OSAL_CCMU_SetMclkSrc (__hdle hMclk, __u32 nSclkNo)
{
      ...
      || hMclk == MOD_CLK_LCD1CH1_S1 || hMclk == MOD_CLK_LCD1CH1_S2 )
  {
    if (nSclkNo == SYS_CLK_PLL3)
    {
      ...
      if (nSclkNo == SYS_CLK_PLL7)
      {
        ...
        if (nSclkNo == SYS_CLK_PLL3X2)
        {
          clk_src = 2;
        }
        else
          if (nSclkNo == SYS_CLK_PLL7X2)
          {
            clk_src = 3;
          }
          else
            if (nSclkNo == SYS_CLK_MIPIPLL)
            {
              clk_src = 4;
            }
  }
  else
    if (hMclk == MOD_CLK_LCD0CH1 || hMclk == MOD_CLK_LCD0CH1 || hMclk ==  MOD_CLK_HDMI
        || hMclk == MOD_CLK_MIPIDSIP || hMclk == MOD_CLK_MIPIDSIS)
    {
      ...
      if (hMclk == MOD_CLK_DEBE0 || hMclk == MOD_CLK_DEBE1 || hMclk == MOD_CLK_DEFE0
          ...
          || hMclk == MOD_CLK_IEPDRC0 || hMclk == MOD_CLK_IEPDRC1 )
      {
        if (nSclkNo == SYS_CLK_PLL3)
        {
          ...
          if (nSclkNo == SYS_CLK_PLL7)
          {
            ...
            if (nSclkNo == SYS_CLK_PLL6x2 || nSclkNo == SYS_CLK_PLL5P)
            {
              clk_src = 2;
            }
            else
              if (nSclkNo == SYS_CLK_PLL8)
              {
                clk_src = 3;
              }
              else
  ...
  if (hMclk == MOD_CLK_LCD0CH1_S1)
  {
    ...
    if (hMclk == MOD_CLK_LCD0CH1_S2)
    {
      value = sys_get_wvalue (0x01c2012c) & (~ (0x3 << 24) );
      sys_put_wvalue (0x01c2012c, value | (clk_src << 24) );
    }
    else
      if (hMclk == MOD_CLK_LCD1CH1_S1)
      {
        value = sys_get_wvalue (0x01c20130) & (~ (0x3 << 24) );
        sys_put_wvalue (0x01c20130, value | (clk_src << 24) );
      }
      else
        if (hMclk == MOD_CLK_LCD1CH1_S2)
        {
          value = sys_get_wvalue (0x01c20130) & (~ (0x3 << 24) );
          sys_put_wvalue (0x01c20130, value | (clk_src << 24) );
        }
