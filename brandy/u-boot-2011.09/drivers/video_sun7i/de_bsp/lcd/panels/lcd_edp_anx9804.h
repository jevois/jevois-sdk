...
#define HDMI_DDC_ACC_ABORT_CURRENT      0x00
#define HDMI_DDC_ACC_DDC_WRITE          0x02
...
#define HDMI_DDC_CHSTATUS_DDCERR	 		0x80
#define HDMI_DDC_CHSTATUS_DDC_OCCUPY	 	0x40
#define HDMI_DDC_CHSTATUS_FIFO_FULL			0x20
#define HDMI_DDC_CHSTATUS_FIFO_EMPT	    	0x10
#define HDMI_DDC_CHSTATUS_NOACK	 			0x08
#define HDMI_DDC_CHSTATUS_FIFO_RD			0x04
#define HDMI_DDC_CHSTATUS_FIFO_WR			0x02
#define HDMI_DDC_CHSTATUS_INPRO				0x01
...
#define HDMI_TMDS_CLKCH_MUTE	 	0x40
...
#define HDMI_INFO_PKTCTRL1_SPD_RPT 	 	0x80
#define HDMI_INFO_PKTCTRL1_SPD_EN	 	0x40
#define HDMI_INFO_PKTCTRL1_AVI_RPT		0x20
#define HDMI_INFO_PKTCTRL1_AVI_EN	    0x10
#define HDMI_INFO_PKTCTRL1_GCP_RPT	 	0x08
#define HDMI_INFO_PKTCTRL1_GCP_EN		0x04
#define HDMI_INFO_PKTCTRL1_ACR_NEW		0x02
#define HDMI_INFO_PKTCTRL1_ACR_EN		0x01

#define HDMI_INFO_PKTCTRL2_REG  	0x71
#define HDMI_INFO_PKTCTRL2_AIF_RPT		0x02
#define HDMI_INFO_PKTCTRL2_AIF_EN		0x01
...
#define HDMI_GNRL_CTRL_CLR_ColorDepth_EN		0x40  
#define HDMI_GNRL_CTRL_CLR_AVMUTE		0x02
#define HDMI_GNRL_CTRL_SET_AVMUTE		0x01
...
#define DP_TX_SYS_CTRL1_PD_IO         					0x80   
#define DP_TX_SYS_CTRL1_PD_VID        					0x40   
#define DP_TX_SYS_CTRL1_PD_LINK       					0x20   
#define DP_TX_SYS_CTRL1_PD_TOTAL      					0x10   
#define DP_TX_SYS_CTRL1_MODE_SEL      					0x08   
#define DP_TX_SYS_CTRL1_DET_STA       					0x04   
#define DP_TX_SYS_CTRL1_FORCE_DET     					0x02   
#define DP_TX_SYS_CTRL1_DET_CTRL      					0x01   

#define DP_TX_SYS_CTRL2_REG           					0x81
#define DP_TX_SYS_CTRL2_CHA_STA       					0x04   
#define DP_TX_SYS_CTRL2_FORCE_CHA     					0x02   
#define DP_TX_SYS_CTRL2_CHA_CTRL      					0x01   

#define DP_TX_SYS_CTRL3_REG           					0x82
#define DP_TX_SYS_CTRL3_HPD_STATUS    					0x40   
#define DP_TX_SYS_CTRL3_F_HPD         					0x20   
#define DP_TX_SYS_CTRL3_HPD_CTRL      					0x10   
#define DP_TX_SYS_CTRL3_STRM_VALID    					0x04   
#define DP_TX_SYS_CTRL3_F_VALID       					0x02   
#define DP_TX_SYS_CTRL3_VALID_CTRL    					0x01   
...
#define DP_TX_PKT_AUD_UP								0x80 
#define DP_TX_PKT_AVI_UD              					0x40 
#define DP_TX_PKT_MPEG_UD             					0x20 
#define DP_TX_PKT_SPD_UD              					0x10 
#define DP_TX_PKT_AUD_EN								0x08 
#define DP_TX_PKT_AVI_EN              					0x04 
#define DP_TX_PKT_MPEG_EN             					0x02 
#define DP_TX_PKT_SPD_EN              					0x01 
...
#define DP_TX_TRAINING_LANE0_SET_MAX_PRE_REACH        0x20       
#define DP_TX_TRAINING_LANE0_SET_MAX_DRIVE_REACH     0x04       
...
#define DP_TX_LINK_TRAINING_CTRL_EN                 0x01       
...
#define DP_TX_DIS_AUTO_RST_ENCODER					0x04	
#define DP_TX_LINK_DEBUG_INSERT_ER                  0x02       
#define DP_TX_LINK_DEBUG_PRBS31_EN                  0x01       

#define DP_TX_SINK_STATUS_REG                       0xBE
#define DP_TX_SINK_STATUS_SINK_STATUS_1          	0x02       
#define DP_TX_SINK_STATUS_SINK_STATUS_0          	0x01       


#define DP_TX_PLL_CTRL_REG											0xC7	
#define DP_TX_PLL_CTRL_PLL_PD           						0x80       
#define DP_TX_PLL_CTRL_PLL_RESET        					0x40       
#define DP_TX_PLL_CTRL_CPREG_BLEED      					0x08       

#define DP_TX_ANALOG_POWER_DOWN_REG                   			0xC8
#define DP_TX_ANALOG_POWER_DOWN_MACRO_PD              	0x20       
#define DP_TX_ANALOG_POWER_DOWN_AUX_PD                		0x10       
#define DP_TX_ANALOG_POWER_DOWN_CH3_PD                		0x08       
#define DP_TX_ANALOG_POWER_DOWN_CH2_PD                		0x04       
#define DP_TX_ANALOG_POWER_DOWN_CH1_PD                		0x02       
#define DP_TX_ANALOG_POWER_DOWN_CH0_PD                		0x01       


#define DP_TX_ANALOG_TEST_REG                         		0xC9
#define DP_TX_ANALOG_TEST_MACRO_RST                   				0x20      
#define DP_TX_ANALOG_TEST_PLL_TEST                    				0x10      
#define DP_TX_ANALOG_TEST_CH3_TEST                    				0x08      
#define DP_TX_ANALOG_TEST_CH2_TEST                    				0x04      
#define DP_TX_ANALOG_TEST_CH1_TEST                    				0x02      
#define DP_TX_ANALOG_TEST_CH0_TEST                    				0x01      

#define DP_TX_FIFO_THRESHOLD                            0xCC

#define DP_TX_GNS_CTRL_REG                            	0xCD
#define DP_TX_GNS_CTRL_VIDEO_MAP_CTRL                 	 0x02      
#define DP_TX_GNS_CTRL_RS_CTRL                        	 0x01      

#define DP_TX_SSC_D_VALUE                               0xD0  
#define DP_TX_DOWN_SPREADING_CTRL2                      0xD1
#define DP_TX_SSC_D_CTRL                                 0x40      
#define DP_TX_FS_CTRL_TH_CTRL                            0x20      
...
#define DP_TX_DEFER_CTRL_DEFER_CTRL_EN  				 0x80      
...
#define DP_TX_RST_MISC_REG 			  	0x80
#define DP_TX_RST_VIDCAP_REG		  	0x40
#define DP_TX_RST_VIDFIF_REG          	0x20   
#define DP_TX_RST_AUDFIF_REG          	0x10   
#define DP_TX_RST_AUDCAP_REG         	0x08   
#define DP_TX_RST_HDCP_REG            	0x04   
#define DP_TX_RST_SW_RST             	0x02   
#define DP_TX_RST_HW_RST             	0x01   
...
#define DP_TX_VID_CTRL1_VID_EN       0x80   
#define DP_TX_VID_CTRL1_VID_MUTE   0x40   
#define DP_TX_VID_CTRL1_DE_GEN      0x20   
#define DP_TX_VID_CTRL1_DEMUX        0x10   
#define DP_TX_VID_CTRL1_IN_BIT		  	0x04   
#define DP_TX_VID_CTRL1_DDRCTRL		0x02   
#define DP_TX_VID_CTRL1_EDGE		  		0x01   

#define DP_TX_VID_CTRL2_REG           	0x09
#define DP_TX_VID_CTRL1_YCBIT_SEL  		0x04   

#define DP_TX_VID_CTRL3_REG           	0x0A

#define DP_TX_VID_CTRL4_REG           	0x0B
#define DP_TX_VID_CTRL4_E_SYNC_EN	  	0x80	 
#define DP_TX_VID_CTRL4_EX_E_SYNC    0x40   
#define DP_TX_VID_CTRL4_BIST          		0x08   
#define DP_TX_VID_CTRL4_BIST_WIDTH   0x04       
...
#define DP_TX_VID_CTRL10_INV_F         	0x08   
#define DP_TX_VID_CTRL10_I_SCAN        	0x04   
#define DP_TX_VID_CTRL10_VSYNC_POL   0x02   
#define DP_TX_VID_CTRL10_HSYNC_POL   0x01   
...
#define DP_COMMON_INT2_AUTHCHG	  0x02
#define DP_COMMON_INT2_AUTHDONE	  0x01
...
#define DP_COMMON_INT4_PLUG      0x01  
#define DP_COMMON_INT4_HPDLOST		0x02  
#define DP_COMMON_INT4_HPD_CHANGE   0x04  
...
#define DP_TX_INT_STATUS1_HPD	  0x40
#define DP_TX_INT_STATUS1_TRAINING_Finish       0x20  
#define DP_TX_INT_STATUS1_POLLING_ERR        0x10  
