...
void DDC_Init()
{
  ...
  HDMI_WUINT32 (0x50c, 0x006000a0);
  HDMI_WUINT32 (0x510, 0x00000000);
  HDMI_WUINT32 (0x518, 0x00000000);
  HDMI_WUINT32 (0x520, 0x00000061);
  HDMI_WUINT32 (0x500, 0x00000051);
  
  HDMI_WUINT32 (0x504, HDMI_RUINT32 (0x504) | 0x00000010);
  HDMI_WUINT32 (0x500, HDMI_RUINT32 (0x500) | 0x08000000);
  while (HDMI_RUINT32 (0x500) & 0x08000000);
  HDMI_WUINT32 (0x504, HDMI_RUINT32 (0x504) & 0xffffffef);
}
...
__s32 DDC_Read (char cmd, char pointer, char offset, int nbyte, char * pbuf)
{
  ...
  while (nbyte > 0)
  {
    ...
    HDMI_WUINT32 (0x518, HDMI_RUINT32 (0x518) | 0x00008000);
    HDMI_WUINT8 (0x50f, pointer );                 
    HDMI_WUINT8 (0x50d, off     );                 
    HDMI_WUINT32 (0x508, (n << 16) + cmd);           
    HDMI_WUINT32 (0x500, HDMI_RUINT32 (0x500) | 0x08000000);
...
__s32 Parse_DTD_Block (__u8 * pbuf)
{
  ...
  */
  ...
  if ( (frame_rate == 59) || (frame_rate == 60) )
  {
    ...
    if ( (frame_rate == 49) || (frame_rate == 50) )
    {
