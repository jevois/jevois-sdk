...
__s32 get_audio_info (__s32 sample_rate)
{
       ...
       (video_mode == HDMI480P)      || (video_mode == HDMI576P)       )
  {
    ...
    if ( (video_mode == HDMI720P_50 ) || (video_mode == HDMI720P_60 ) ||
         ...
         || (video_mode == HDMI1080P_25) || (video_mode == HDMI1080P_30) )
    {
      ...
      if ( (video_mode == HDMI1080P_50)       || (video_mode == HDMI1080P_60)       ||
...
__s32 video_config (__s32 vic)
{
  ...
  if ( (vic == HDMI1440_480I) || (vic == HDMI1440_576I) )  
  {
    ...
    if ( (vic == HDMI1080I_50) || (vic == HDMI1080I_60) )
    {
  ...
  {
    HDMI_WUINT16 (0x016, video_timing[vic_tab].INPUTY + video_timing[vic_tab].VBP + video_timing[vic_tab].VFP - 1);  
  }
  else
  {
  ...
  HDMI_WUINT16 (0x01a, video_timing[vic_tab].VBP    - 1);                
  HDMI_WUINT16 (0x01e, video_timing[vic_tab].VFP    - 1);                
  HDMI_WUINT16 (0x022, video_timing[vic_tab].VPSW   - 1);                
  
  if ( video_timing[vic_tab].PCLK < 74250000)      
  {
    HDMI_WUINT16 (0x024, 0x00   );                 
  }
  else                       
  {
    HDMI_WUINT16 (0x024, 0x03   );         
  }
  
  HDMI_WUINT16 (0x026, 0x03e0 );       
  ...
  HDMI_WUINT8 (0x243, 0x29);
  HDMI_WUINT8 (0x244, 0x03);
  HDMI_WUINT8 (0x245, 0x0c); 
  HDMI_WUINT8 (0x246, 0x00);
  HDMI_WUINT8 (0x247, 0x40); 
  HDMI_WUINT8 (0x248, 0x00);
  
  HDMI_WUINT8 (0x249, 0x00); 
  HDMI_WUINT8 (0x24a, 0x00); 
  ...
  HDMI_WUINT32 (0x300, 0x08000000);  
  
  HDMI_WUINT8 (0x013, 0xc0);     
  HDMI_WUINT32 (0x004, 0x80000000);  
  if ( (vic == HDMI1440_480I) || (vic == HDMI1440_576I) )
  {
...
__s32 audio_config (void)
{
  ...
  {
    HDMI_WUINT32 (0x044, 0x80000000);            
    HDMI_WUINT32 (0x048, 0x00000000);    
    HDMI_WUINT32 (0x04c, 0x76543200);
    
    HDMI_WUINT32 (0x0A0, 0x710a0184);            
    HDMI_WUINT32 (0x0A4, 0x00000000);            
    ...
    if (audio_info.channel_num == 2)
    {
      ...
      if (audio_info.data_raw == 0)
      {
        ...
        HDMI_WUINT32 (0x048, 0x00000001);    
      }
      else
      {
      
        HDMI_WUINT32 (0x048, 0x01000001);    
      }
      ...
      if (audio_info.channel_num == 8)
      {
        HDMI_WUINT32 (0x044, 0x80000000);            
        HDMI_WUINT32 (0x048, 0x0000000f);    
        HDMI_WUINT32 (0x04c, 0x76543210);
        
        HDMI_WUINT32 (0x0A0, 0x520a0184);            
        HDMI_WUINT32 (0x0A4, 0x1F000000);            
        HDMI_WUINT32 (0x0A8, 0x00000000);
        HDMI_WUINT32 (0x0Ac, 0x00000000);
      }
      else
  ...
  HDMI_WUINT32 (0x050, audio_info.CTS     );                 
  ...
  sys_put_wvalue (0xf1c023a8, 0x00000000);
  sys_put_wvalue (0xf1c023ac, 0x01f00000);
  sys_put_wvalue (0xf1c023b8, (31 << 24) + (7 << 16) + (31 << 8) + (7 << 0) );
...
__s32 hdmi_main_task_loop (void)
{
  ...
  case HDMI_State_EDID_Parse:
    ...
    HDMI_WUINT32 (0x200, 0xfe800000);      
    HDMI_WUINT32 (0x204, 0x00D8C850);      
...
__s32 video_config (__s32 vic)
{
  ...
  if ( (vic == HDMI1440_480I) || (vic == HDMI1440_576I) )    
  {
    HDMI_WUINT16 (0x014, (video_timing[i].INPUTX << 1) - 1);         
    HDMI_WUINT16 (0x018, (video_timing[i].HBP << 1)    - 1);         
    HDMI_WUINT16 (0x01c, (video_timing[i].HFP << 1)    - 1);       
    HDMI_WUINT16 (0x020, (video_timing[i].HPSW << 1)   - 1);       
  }
  else
  {
    HDMI_WUINT16 (0x014, (video_timing[i].INPUTX << 0) - 1);         
    HDMI_WUINT16 (0x018, (video_timing[i].HBP << 0)    - 1);         
    HDMI_WUINT16 (0x01c, (video_timing[i].HFP << 0)    - 1);       
    HDMI_WUINT16 (0x020, (video_timing[i].HPSW << 0)   - 1);           
  }

  if ( ( vic == HDMI1080P_24_3D_FP) || (vic == HDMI720P_50_3D_FP ) || (vic == HDMI720P_60_3D_FP ) )
  {
    HDMI_WUINT16 (0x016, video_timing[i].INPUTY + video_timing[i].VBP + video_timing[i].VFP - 1);            
  }
  else
  {
    HDMI_WUINT16 (0x016, video_timing[i].INPUTY   - 1);              
  }

  HDMI_WUINT16 (0x01a, video_timing[i].VBP    - 1);                
  HDMI_WUINT16 (0x01e, video_timing[i].VFP    - 1);                  
  HDMI_WUINT16 (0x022, video_timing[i].VPSW   - 1);                
