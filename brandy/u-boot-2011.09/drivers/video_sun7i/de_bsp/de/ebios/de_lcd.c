...
__s32 tcon0_cfg_mode_tri (__u32 sel, __panel_para_t * panel)
{
  ...
  */
  if ( (panel->lcd_if == LCD_IF_CPU) || (panel->lcd_if == LCD_IF_DSI && panel->lcd_dsi_if == LCD_DSI_IF_COMMAND_MODE) )
  {
    ...
    if ( (panel->lcd_if == LCD_IF_DSI) && (panel->lcd_dsi_if == LCD_DSI_IF_VIDEO_MODE || panel->lcd_dsi_if == LCD_DSI_IF_BURST_MODE) )
    {
...
__disp_timing_t tv_timing_tbl[30] = {
  { 13500000,  720,  480,  858,  19,  62,  57,  525,   4,   3,  15,   0,   0,   1,  0, 0}, 
  { 13500000,  720,  576,  864,  12,  63,  69,  625,   2,   3,  19,   0,   0,   1,  0, 0}, 
  { 27000000,  720,  480,  858,  16,  62,  60,  525,   9,   6,  30,   0,   0,   0,  0, 0}, 
  { 27000000,  720,  576,  864,  12,  64,  68,  625,   5,   5,  39,   0,   0,   0,  0, 0}, 
  { 74250000, 1280,  720, 1980, 440,  40, 220,  750,   5,   5,  20,   1,   1,   0,  0, 0}, 
  { 74250000, 1280,  720, 1650, 110,  40, 220,  750,   5,   5,  20,   1,   1,   0,  0, 0}, 
  { 74250000, 1920, 1080, 2640, 528,  44, 148, 1125,   2,   5,  15,   1,   1,   1,  0, 0}, 
  { 74250000, 1920, 1080, 2200,  88,  44, 148, 1125,   2,   5,  15,   1,   1,   1,  0, 0}, 
  { 74250000, 1920, 1080, 2750, 638,  44, 148, 1125,   4,   5,  36,   1,   1,   0,  0, 0}, 
  {148500000, 1920, 1080, 2640, 528,  44, 148, 1125,   4,   5,  36,   1,   1,   0,  0, 0}, 
  {148500000, 1920, 1080, 2200,  88,  44, 148, 1125,   4,   5,  36,   1,   1,   0,  0, 0}, 
  {000000000, 0000, 0000, 0000,  00,  00, 000, 0000,   0,   0,  00,   0,   0,   0,  0, 0}, 
  {000000000, 0000, 0000, 0000,  00,  00, 000, 0000,   0,   0,  00,   0,   0,   0,  0, 0}, 
  {000000000, 0000, 0000, 0000,  00,  00, 000, 0000,   0,   0,  00,   0,   0,   0,  0, 0}, 
  {000000000, 0000, 0000, 0000,  00,  00, 000, 0000,   0,   0,  00,   0,   0,   0,  0, 0}, 
  {000000000, 0000, 0000, 0000,  00,  00, 000, 0000,   0,   0,  00,   0,   0,   0,  0, 0}, 
  ...
  {000000000, 0000, 0000, 0000,  00,  00, 000, 0000,   0,   0,  00,   0,   0,   0,  0, 0},  
  {000000000, 0000, 0000, 0000,  00,  00, 000, 0000,   0,   0,  00,   0,   0,   0,  0, 0},  
  {148500000, 1920, 2160, 2750, 638,  44, 148, 1125,   4,   5,  36,   1,   1,   0, 45, 1}, 
  {148500000, 1280, 1440, 1980, 440,  40, 220,  750,   5,   5,  20,   1,   1,   0, 30, 1}, 
  {148500000, 1280, 1440, 1650, 110,  40, 220,  750,   5,   5,  20,   1,   1,   0, 30 , 1},
};
...
__s32 tcon1_set_vga_mode (__u32 sel, __disp_vga_mode_t mode)
{
  ...
  case  DISP_VGA_H1920_V1080://TBD
    ...
    cfg.ver_back_porch      = 148 + 44;
    cfg.ver_total_time       = 1125 * 2;
    cfg.ver_back_porch      = 36 + 5;
    cfg.ver_sync_time     = 5;//VS-1=-1
  ...
  case  DISP_VGA_H1280_V720://TBD
    ...
    cfg.ver_back_porch      = 220 + 40;
    cfg.ver_total_time       = 750 * 2;
    cfg.ver_back_porch      = 5 + 20;
    cfg.ver_sync_time     = 5;//VS-1=-1
