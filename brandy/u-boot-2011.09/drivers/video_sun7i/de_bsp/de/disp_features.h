...
struct sunxi_disp_features {
  ...
  const __disp_para_range * layer_horizontal_resolution;
  const __disp_para_range * layer_vertical_resolution;
  const __disp_para_range * scaler_horizontal_resolution;
  const __disp_para_range * scaler_vertical_resolution;
  const int * scaler_horizontal_resolution_in_out_limit;
  const int * scaler_vertical_resolution_in_out_limit;
  const int num_wbs;
