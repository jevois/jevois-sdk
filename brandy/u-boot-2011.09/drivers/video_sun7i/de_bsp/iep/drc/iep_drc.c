...
static __drc_t giep[2];
static __drc_pwrsv_t gpwrsv[2];
static __u32 * pttab[2]; 
static __u32 printf_cnt = 0;
...
__s32 drc_init (__u32 sel)
{
  ...
  DRC_EBIOS_Drc_Adjust_Enable (sel, 0);
  DRC_EBIOS_Drc_Set_Lgc_Autoload_Disable (sel, 0);
  DRC_EBIOS_Lh_Set_Mode (sel, 0);
...
__s32 iep_drc_resume (__u32 sel)
{
  __u32 i;
  __u32 reg_val;
