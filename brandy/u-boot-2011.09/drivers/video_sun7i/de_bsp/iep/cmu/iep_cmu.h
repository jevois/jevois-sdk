...
#define IMGEHC_CMU_CTL_REG_ADDR           		( CMU_VBASE + IMGEHC_CMU_CTL_REG_OFF            )	
#define IMGEHC_CMU_STS_REG_ADDR           		( CMU_VBASE + IMGEHC_CMU_STS_REG_OFF            )	
#define IMGEHC_CMU_REGBUFFCTL_REG_ADDR    		( CMU_VBASE + IMGEHC_CMU_REGBUFFCTL_REG_OFF     )	
#define IMGEHC_CMU_INSIZE_REG_ADDR        		( CMU_VBASE + IMGEHC_CMU_INSIZE_REG_OFF         )	
#define IMGEHC_CMU_OWP_REG0_ADDR          		( CMU_VBASE + IMGEHC_CMU_OWP_REG0_OFF           )	
#define IMGEHC_CMU_OWP_REG1_ADDR          		( CMU_VBASE + IMGEHC_CMU_OWP_REG1_OFF           )	
#define IMGEHC_CMU_HRANGE_REG0_ADDR       		( CMU_VBASE + IMGEHC_CMU_HRANGE_REG0_OFF        )	
#define IMGEHC_CMU_HRANGE_REG1_ADDR       		( CMU_VBASE + IMGEHC_CMU_HRANGE_REG1_OFF        )	
#define IMGEHC_CMU_HRANGE_REG2_ADDR       		( CMU_VBASE + IMGEHC_CMU_HRANGE_REG2_OFF        )	
#define IMGEHC_CMU_HRANGE_REG3_ADDR       		( CMU_VBASE + IMGEHC_CMU_HRANGE_REG3_OFF        )	
#define IMGEHC_CMU_HRANGE_REG4_ADDR       		( CMU_VBASE + IMGEHC_CMU_HRANGE_REG4_OFF        )	
#define IMGEHC_CMU_HRANGE_REG5_ADDR       		( CMU_VBASE + IMGEHC_CMU_HRANGE_REG5_OFF        )	
#define IMGEHC_CMU_HRANGE_REG6_ADDR       		( CMU_VBASE + IMGEHC_CMU_HRANGE_REG6_OFF        )	
#define IMGEHC_CMU_VRANGE_HLGAIN_REG0_ADDR		( CMU_VBASE + IMGEHC_CMU_VRANGE_HLGAIN_REG0_OFF )	
#define IMGEHC_CMU_VRANGE_HLGAIN_REG1_ADDR		( CMU_VBASE + IMGEHC_CMU_VRANGE_HLGAIN_REG1_OFF )	
#define IMGEHC_CMU_VRANGE_HLGAIN_REG2_ADDR		( CMU_VBASE + IMGEHC_CMU_VRANGE_HLGAIN_REG2_OFF )	
#define IMGEHC_CMU_VRANGE_HLGAIN_REG3_ADDR		( CMU_VBASE + IMGEHC_CMU_VRANGE_HLGAIN_REG3_OFF )	
#define IMGEHC_CMU_VRANGE_HLGAIN_REG4_ADDR		( CMU_VBASE + IMGEHC_CMU_VRANGE_HLGAIN_REG4_OFF )	
#define IMGEHC_CMU_VRANGE_HLGAIN_REG5_ADDR		( CMU_VBASE + IMGEHC_CMU_VRANGE_HLGAIN_REG5_OFF )	
#define IMGEHC_CMU_VRANGE_HLGAIN_REG6_ADDR		( CMU_VBASE + IMGEHC_CMU_VRANGE_HLGAIN_REG6_OFF )	
#define IMGEHC_CMU_HGGAIN_REG_ADDR        		( CMU_VBASE + IMGEHC_CMU_HGGAIN_REG_OFF         )	
#define IMGEHC_CMU_SRANGE_REG0_ADDR       		( CMU_VBASE + IMGEHC_CMU_SRANGE_REG0_OFF        )	
#define IMGEHC_CMU_SRANGE_REG1_ADDR       		( CMU_VBASE + IMGEHC_CMU_SRANGE_REG1_OFF        )	
#define IMGEHC_CMU_SRANGE_REG2_ADDR       		( CMU_VBASE + IMGEHC_CMU_SRANGE_REG2_OFF        )	
#define IMGEHC_CMU_SRANGE_REG3_ADDR       		( CMU_VBASE + IMGEHC_CMU_SRANGE_REG3_OFF        )	
#define IMGEHC_CMU_SRANGE_REG4_ADDR       		( CMU_VBASE + IMGEHC_CMU_SRANGE_REG4_OFF        )	
#define IMGEHC_CMU_SRANGE_REG5_ADDR       		( CMU_VBASE + IMGEHC_CMU_SRANGE_REG5_OFF        )	
#define IMGEHC_CMU_SRANGE_REG6_ADDR       		( CMU_VBASE + IMGEHC_CMU_SRANGE_REG6_OFF        )	
#define IMGEHC_CMU_LOCAL_SVGAIN_REG0_ADDR 		( CMU_VBASE + IMGEHC_CMU_LOCAL_SVGAIN_REG0_OFF  )	
#define IMGEHC_CMU_LOCAL_SVGAIN_REG1_ADDR 		( CMU_VBASE + IMGEHC_CMU_LOCAL_SVGAIN_REG1_OFF  )	
#define IMGEHC_CMU_LOCAL_SVGAIN_REG2_ADDR 		( CMU_VBASE + IMGEHC_CMU_LOCAL_SVGAIN_REG2_OFF  )	
#define IMGEHC_CMU_LOCAL_SVGAIN_REG3_ADDR 		( CMU_VBASE + IMGEHC_CMU_LOCAL_SVGAIN_REG3_OFF  )	
#define IMGEHC_CMU_LOCAL_SVGAIN_REG4_ADDR 		( CMU_VBASE + IMGEHC_CMU_LOCAL_SVGAIN_REG4_OFF  )	
#define IMGEHC_CMU_LOCAL_SVGAIN_REG5_ADDR 		( CMU_VBASE + IMGEHC_CMU_LOCAL_SVGAIN_REG5_OFF  )	
#define IMGEHC_CMU_LOCAL_SVGAIN_REG6_ADDR 		( CMU_VBASE + IMGEHC_CMU_LOCAL_SVGAIN_REG6_OFF  )	
#define IMGEHC_CMU_GLOBAL_SVGAIN_REG_ADDR 		( CMU_VBASE + IMGEHC_CMU_GLOBAL_SVGAIN_REG_OFF  )	
...
typedef union
{
	...
	struct
	{
		u32 cmu_regloadctl  :  1 ;   
		u32 cmu_regautoload :  1 ;   
		u32 res0            : 30 ;   
	} bits;
