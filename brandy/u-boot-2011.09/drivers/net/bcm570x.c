...
int eth_init (bd_t * bis)
{
  ...
  { printf ("Broadcom BCM5400 Copper "); }
    ...
    { printf ("Broadcom BCM5401 Copper "); }
      ...
      if ( (pDevice->PhyId & PHY_ID_MASK) == PHY_BCM5411_PHY_ID)
      { printf ("Broadcom BCM5411 Copper "); }
      else
        if ( (pDevice->PhyId & PHY_ID_MASK) == PHY_BCM5701_PHY_ID)
        { printf ("Broadcom BCM5701 Integrated Copper "); }
        else
          if ( (pDevice->PhyId & PHY_ID_MASK) == PHY_BCM5703_PHY_ID)
          { printf ("Broadcom BCM5703 Integrated Copper "); }
          else
            if ( (pDevice->PhyId & PHY_ID_MASK) == PHY_BCM8002_PHY_ID)
