        ...
        if (!strncmp (vol_name, "fldo", 4) )
        {
          ...
          if (!strncmp (vol_name, "dldo", 4) )
          {
            ...
            if (!strncmp (vol_name, "gpio", 4) )
            {
              ...
              if (!strncmp (vol_name, "dc5ldo", 6) )
              {
                return axp81X_set_dc5ldo (onoff);
              }
              else
                if (!strncmp (vol_name, "dc1sw", 5) )
                {
                  return axp81X_set_dc1sw (onoff);
                }
                else
                  if (!strncmp (vol_name, "power", 5) )
                  {
