...
/* DMA 传输目的端 配置 */
#define DMAC_CFG_WAIT_1_DMA_CLOCK       (0x00) 
#define DMAC_CFG_WAIT_2_DMA_CLOCK       (0x01) 
#define DMAC_CFG_WAIT_3_DMA_CLOCK       (0x02) 
#define DMAC_CFG_WAIT_4_DMA_CLOCK       (0x03) 
#define DMAC_CFG_WAIT_5_DMA_CLOCK       (0x04) 
#define DMAC_CFG_WAIT_6_DMA_CLOCK       (0x05) 
#define DMAC_CFG_WAIT_7_DMA_CLOCK       (0x06) 
#define DMAC_CFG_WAIT_8_DMA_CLOCK       (0x07) 
...
#define DMAC_CFG_DEST_ADDR_TYPE_HPAGE_MODE    (0x02) 
#define DMAC_CFG_DEST_ADDR_TYPE_VPAGE_MODE    (0x03) 
...
#define DMAC_CFG_SRC_ADDR_TYPE_HPAGE_MODE     (0x02) 
#define DMAC_CFG_SRC_ADDR_TYPE_VPAGE_MODE     (0x03) 


/* DMA 传输目的端 配置 */
#define DMAC_CFG_DEST_TYPE_IR         (0x00) 
#define DMAC_CFG_DEST_TYPE_SPDIF          (0x01) 
#define DMAC_CFG_DEST_TYPE_IIS            (0x02) 
#define DMAC_CFG_DEST_TYPE_AC97           (0x03) 
#define DMAC_CFG_DEST_TYPE_SPI0           (0x04) 
#define DMAC_CFG_DEST_TYPE_SPI1           (0x05) 
#define DMAC_CFG_DEST_TYPE_SPI2           (0x06) 
#define DMAC_CFG_DEST_TYPE_UART0        (0x08) 
#define DMAC_CFG_DEST_TYPE_UART1        (0x09) 
#define DMAC_CFG_DEST_TYPE_UART2        (0x0a) 
#define DMAC_CFG_DEST_TYPE_UART3        (0x0b) 
#define DMAC_CFG_DEST_TYPE_AUDIO_DA       (0x0c) 

#define DMAC_CFG_DEST_TYPE_NFC_DEBUG      (0x0f) 
#define DMAC_CFG_DEST_TYPE_N_SRAM         (0x10) 
#define DMAC_CFG_DEST_TYPE_N_SDRAM        (0x11) 
#define DMAC_CFG_DEST_TYPE_UART4        (0x12) 
#define DMAC_CFG_DEST_TYPE_UART5        (0x13) 
#define DMAC_CFG_DEST_TYPE_UART6        (0x14) 
#define DMAC_CFG_DEST_TYPE_UART7        (0x15) 

#define DMAC_CFG_DEST_TYPE_D_SRAM         (0x00) 
#define DMAC_CFG_DEST_TYPE_D_SDRAM        (0x01) 
#define DMAC_CFG_DEST_TYPE_TCON0        (0x02) 
#define DMAC_CFG_DEST_TYPE_NFC            (0x03) 
#define DMAC_CFG_DEST_TYPE_USB0           (0x04) 
#define DMAC_CFG_DEST_TYPE_USB1           (0x05) 
#define DMAC_CFG_DEST_TYPE_SDC1           (0x07) 
#define DMAC_CFG_DEST_TYPE_SDC2         (0x08) 
#define DMAC_CFG_DEST_TYPE_SDC3         (0x09) 
#define DMAC_CFG_DEST_TYPE_MSC          (0x0a) 
#define DMAC_CFG_DEST_TYPE_EMAC         (0x0b) 
#define DMAC_CFG_DEST_TYPE_SS           (0x0d) 
#define DMAC_CFG_DEST_TYPE_USB2           (0x0f) 
#define DMAC_CFG_DEST_TYPE_ATA            (0x10) 
/* DMA 传输源端 配置 */
#define DMAC_CFG_SRC_TYPE_IR          (0x00) 
#define DMAC_CFG_SRC_TYPE_SPDIF             (0x01) 
#define DMAC_CFG_SRC_TYPE_IIS           (0x02) 
#define DMAC_CFG_SRC_TYPE_AC97            (0x03) 
#define DMAC_CFG_SRC_TYPE_SPI0            (0x04) 
#define DMAC_CFG_SRC_TYPE_SPI1            (0x05) 
#define DMAC_CFG_SRC_TYPE_SPI2            (0x06) 
#define DMAC_CFG_SRC_TYPE_UART0           (0x08) 
#define DMAC_CFG_SRC_TYPE_UART1           (0x09) 
#define DMAC_CFG_SRC_TYPE_UART2           (0x0a) 
#define DMAC_CFG_SRC_TYPE_UART3           (0x0b) 
#define DMAC_CFG_SRC_TYPE_AUDIO         (0x0c) 
#define DMAC_CFG_SRC_TYPE_TP            (0x0d) 

#define DMAC_CFG_SRC_TYPE_NFC_DEBUG         (0x0f) 
#define DMAC_CFG_SRC_TYPE_N_SRAM        (0x10) 
#define DMAC_CFG_SRC_TYPE_N_SDRAM       (0x11) 
#define DMAC_CFG_SRC_TYPE_UART4           (0x12) 
#define DMAC_CFG_SRC_TYPE_UART5           (0x13) 
#define DMAC_CFG_SRC_TYPE_UART6           (0x14) 
#define DMAC_CFG_SRC_TYPE_UART7           (0x15) 

#define DMAC_CFG_SRC_TYPE_D_SRAM        (0x00) 
#define DMAC_CFG_SRC_TYPE_D_SDRAM       (0x01) 
#define DMAC_CFG_SRC_TYPE_TCON0           (0x02) 
#define DMAC_CFG_SRC_TYPE_NFC               (0x03) 
#define DMAC_CFG_SRC_TYPE_USB0            (0x04) 
#define DMAC_CFG_SRC_TYPE_USB1            (0x05) 
#define DMAC_CFG_SRC_TYPE_SDC1            (0x07) 
#define DMAC_CFG_SRC_TYPE_SDC2            (0x08) 
#define DMAC_CFG_SRC_TYPE_SDC3            (0x09) 
#define DMAC_CFG_SRC_TYPE_MSC             (0x0a) 
#define DMAC_CFG_SRC_TYPE_EMAC            (0x0c) 
#define DMAC_CFG_SRC_TYPE_SS              (0x0e) 
#define DMAC_CFG_SRC_TYPE_USB2            (0x0f) 
#define DMAC_CFG_SRC_TYPE_ATA           (0x10) 
