...
int do_ecc (cmd_tbl_t * cmdtp, int flag, int argc, char * const argv[])
{
  ...
  if (argc == 2) {
    if (strcmp (argv[1], "status") == 0) {
      ...
      if (strcmp (argv[1], "captureclear") == 0) {
      ...
      if (strcmp (argv[1], "sbethr") == 0) {
        ...
        if (strcmp (argv[1], "errdisable") == 0) {
          ...
          if (strcmp (argv[2], "+sbe") == 0) {
            ...
            if (strcmp (argv[2], "+mbe") == 0) {
              val |= ECC_ERROR_DISABLE_MBED;
            }
            else
              if (strcmp (argv[2], "+mse") == 0) {
          ...
          if (strcmp (argv[1], "errdetectclr") == 0) {
            val = ddr->err_detect;
            ...
            if (strcmp (argv[1], "injectdatahi") == 0) {
              ...
              if (strcmp (argv[1], "injectdatalo") == 0) {
                val = simple_strtoul (argv[2], NULL, 16);
