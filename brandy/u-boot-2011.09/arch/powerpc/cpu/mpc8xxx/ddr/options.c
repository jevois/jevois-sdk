                                      ...
                                      unsigned int ctrl_num)
{
  ...
  if (pdimm[0].n_ranks != 0) {
    ...
    { popts->data_bus_width = 0; }
      ...
      if (pdimm[0].primary_sdram_width == 32)
      { popts->data_bus_width = 1; }
      else
        if (pdimm[0].primary_sdram_width == 16)
  ...
  if (hwconfig_sub_f ("fsl_ddr", "ctlr_intlv", buf) ) {
    if (pdimm[0].n_ranks == 0) {
      ...
      if (hwconfig_subarg_cmp_f ("fsl_ddr", "ctlr_intlv",
        ...
        if (hwconfig_subarg_cmp_f ("fsl_ddr",
                                   "ctlr_intlv",
                                   "cacheline", buf) )
  ...
  if (hwconfig_sub_f ("fsl_ddr", "addr_hash", buf) ) {
    ...
    { popts->addr_hash = 0; }
      ...
      if (hwconfig_subarg_cmp_f ("fsl_ddr", "addr_hash",
                                 "true", buf) )
      { popts->addr_hash = 1; }
  }
...
int fsl_use_spd (void)
{
  ...
  if (hwconfig_sub_f ("fsl_ddr", "sdram", buf) ) {
    ...
    { use_spd = 1; }
      ...
      if (hwconfig_subarg_cmp_f ("fsl_ddr", "sdram",
                                 "fixed", buf) )
      { use_spd = 0; }
      else
      { use_spd = 1; }
