                              ...
                              u32 tlb_word2_i_value)
{
  ...
  while (mem_size != 0) {
    ...
    if ( ( (phys_addr & TLB_256MB_ALIGN_MASK) == phys_addr) &&
      ...
      if ( ( (phys_addr & TLB_16MB_ALIGN_MASK) == phys_addr) &&
        ...
        if ( ( (phys_addr & TLB_1MB_ALIGN_MASK) == phys_addr) &&
          ...
          if ( ( (phys_addr & TLB_256KB_ALIGN_MASK) == phys_addr) &&
            ...
            if ( ( (phys_addr & TLB_64KB_ALIGN_MASK) == phys_addr) &&
              ...
              if ( ( (phys_addr & TLB_16KB_ALIGN_MASK) == phys_addr) &&
                ...
                if ( ( (phys_addr & TLB_4KB_ALIGN_MASK) == phys_addr) &&
                  ...
                  if ( ( (phys_addr & TLB_1KB_ALIGN_MASK) == phys_addr) &&
