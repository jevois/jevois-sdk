                           ...
                           unsigned long num_dimm_banks)
{
  ...
  if ( (dimm_64bit == TRUE) && (dimm_32bit == TRUE) ) {
    ...
    if ( (dimm_64bit == TRUE) && (dimm_32bit == FALSE) ) {
      mcopt1 |= SDRAM_MCOPT1_DMWD_64;
    }
    else
      if ( (dimm_64bit == FALSE) && (dimm_32bit == TRUE) ) {
                             ...
                             int write_recovery)
{
  ...
  if ( (dimm_populated[0] == SDRAM_DDR1) || (dimm_populated[1] == SDRAM_DDR1) ) {
    ...
    if ( (dimm_populated[0] == SDRAM_DDR2) || (dimm_populated[1] == SDRAM_DDR2) ) {
      switch (selected_cas) {
      case DDR_CAS_3:
        cas = 3 << 4;
        break;
  ...
  if (sdram_ddr1 == TRUE) { /* DDR1 */
    if ( (cas_2_0_available == TRUE) && (sdram_freq <= cycle_2_0_clk) ) {
      ...
      *selected_cas = DDR_CAS_2;
      ...
      if ( (cas_2_5_available == TRUE) && (sdram_freq <= cycle_2_5_clk) ) {
    ...
    if ( (cas_3_0_available == TRUE) && (sdram_freq <= cycle_3_0_clk) ) {
      ...
      *selected_cas = DDR_CAS_3;
      ...
      if ( (cas_4_0_available == TRUE) && (sdram_freq <= cycle_4_0_clk) ) {
        mmode |= SDRAM_MMODE_DCL_DDR2_4_0_CLK;
        *selected_cas = DDR_CAS_4;
      }
      else
        if ( (cas_5_0_available == TRUE) && (sdram_freq <= cycle_5_0_clk) ) {
