...
#define MC_MCR0(x)				(MCTL_COM_BASE + 0x10 + 0x8 * x)		   
#define MC_MCR1(x)				(MCTL_COM_BASE + 0x14 + 0x8 * x)		   
...
#define MX_DRAMTMG(x)			(MCTL_CTL_BASE + 0x100 + 0x4 * x)		
#define MX_ZQCTL(x)				(MCTL_CTL_BASE + 0x180 + 0x4 * x)		
#define MX_ZQSTAT				(MCTL_CTL_BASE + 0x18C)
#define MX_PITMG(x)				(MCTL_CTL_BASE + 0x190 + 0x4 * x)		
#define MX_PLPCFG0				(MCTL_CTL_BASE + 0x198)
#define MX_UPD(x)				(MCTL_CTL_BASE + 0x1A0 + 0x4 * x)		
#define MX_PIMISC         		(MCTL_CTL_BASE + 0x1B0)
#define MX_TRAINCTL(x)			(MCTL_CTL_BASE + 0x1D0 + 0x4 * x)		
...
#define MX_PERFSHPR(x)			(MCTL_CTL_BASE + 0x258 + 0x4 * x)		
#define MX_PERFLPR(x)			(MCTL_CTL_BASE + 0x260 + 0x4 * x)		
#define MX_PERFWR(x)			(MCTL_CTL_BASE + 0x268 + 0x4 * x)		

#define MP_PIR					(MCTL_PHY_BASE + 0x4)
#define MP_PGCR(x)				(MCTL_PHY_BASE + 0x8 + 0x4 * x)			
#define MP_PGSR(x)				(MCTL_PHY_BASE + 0x10 + 0x4 * x)		
#define MP_DLLGCR				(MCTL_PHY_BASE + 0x18)
#define MP_PTR(x)				(MCTL_PHY_BASE + 0x1C + 0x4 * x)		
...
#define MP_DTPR(x)				(MCTL_PHY_BASE + 0x48 + 0x4 * x)		
#define MP_MR(x)				(MCTL_PHY_BASE + 0x54 + 0x4 * x)		
#define MP_ODTCR				(MCTL_PHY_BASE + 0x64)
#define MP_DTCR					(MCTL_PHY_BASE + 0x68)
#define MP_DTAR(x)				(MCTL_PHY_BASE + 0x6C + 0x4 * x)		
#define MP_DTDR(x)				(MCTL_PHY_BASE + 0x7C + 0x4 * x)		
#define MP_DTEDR(x)				(MCTL_PHY_BASE + 0x84 + 0x4 * x)		
#define MP_PGCR2				(MCTL_PHY_BASE + 0x8C)
#define MP_BISTRR				(MCTL_PHY_BASE + 0x100)
#define MP_BISTWCR				(MCTL_PHY_BASE + 0x104)
#define MP_BISTMSKR(x)			(MCTL_PHY_BASE + 0x108 + 0x4 * x)		
#define MP_BISTLSR				(MCTL_PHY_BASE + 0x114)
#define MP_BISTAR(x)			(MCTL_PHY_BASE + 0x118 + 0x4 * x)		
#define MP_BISTUDPR				(MCTL_PHY_BASE + 0x124)
#define MP_BISTGSR				(MCTL_PHY_BASE + 0x128)
#define MP_BISTWER				(MCTL_PHY_BASE + 0x12C)
#define MP_BISTBER(x)			(MCTL_PHY_BASE + 0x130 + 0x4 * x)		
#define MP_BISTWCSR				(MCTL_PHY_BASE + 0x140)
#define MP_BISTFWR(x)			(MCTL_PHY_BASE + 0x144 + 0x4 * x)		
#define MP_ZQCR0(x)				(MCTL_PHY_BASE + 0x180 + 0x10 * x)		
#define MP_ZQCR1(x)				(MCTL_PHY_BASE + 0x184 + 0x10 * x)		
#define MP_ZQCR2				(MCTL_PHY_BASE + 0x190)
#define MP_ZQSR0(x)				(MCTL_PHY_BASE + 0x188 + 0x10 * x)		
#define MP_ZQSR1(x)				(MCTL_PHY_BASE + 0x18C + 0x10 * x)		
#define MP_DXGCR(x)				(MCTL_PHY_BASE + 0x1C0 + 0x40 * x)		
#define MP_DXGSR0(x)			(MCTL_PHY_BASE + 0x1C4 + 0x40 * x)		
#define MP_DXGSR1(x)			(MCTL_PHY_BASE + 0x1C8 + 0x40 * x)		
#define MP_DXBDLR0(x)			(MCTL_PHY_BASE + 0x1CC + 0x40 * x)		
#define MP_DXBDLR1(x)			(MCTL_PHY_BASE + 0x1D0 + 0x40 * x)		
#define MP_DXBDLR2(x)			(MCTL_PHY_BASE + 0x1D4 + 0x40 * x)		
#define MP_DXBDLR3(x)			(MCTL_PHY_BASE + 0x1D8 + 0x40 * x)		
#define MP_DXBDLR4(x)			(MCTL_PHY_BASE + 0x1DC + 0x40 * x)		
#define MP_DXLCDLR0(x)			(MCTL_PHY_BASE + 0x1E0 + 0x40 * x)		
#define MP_DXLCDLR1(x)			(MCTL_PHY_BASE + 0x1E4 + 0x40 * x)		
#define MP_DXLCDLR2(x)			(MCTL_PHY_BASE + 0x1E8 + 0x40 * x)		
#define MP_DXMDLR(x)			(MCTL_PHY_BASE + 0x1EC + 0x40 * x)		
#define MP_DXGTR(x)				(MCTL_PHY_BASE + 0x1F0 + 0x40 * x)		
#define MP_DXGSR2(x)			(MCTL_PHY_BASE + 0x1F4 + 0x40 * x)		
