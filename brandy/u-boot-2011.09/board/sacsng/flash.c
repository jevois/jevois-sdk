...
static ulong flash_get_size (vu_short * addr, flash_info_t * info)
{
  ...
  if (value == (ushort) AMD_ID_LV400T) {
    ...
    if (value == (ushort) AMD_ID_LV400B) {
      info->flash_id += FLASH_AM400B;
      info->sector_count = 11;
      info->size = 0x00080000;  /* => 0.5 MB    */
    }
    else
      if (value == (ushort) AMD_ID_LV800T) {
        info->flash_id += FLASH_AM800T;
        info->sector_count = 19;
        info->size = 0x00100000;  /* => 1 MB    */
      }
      else
        if (value == (ushort) AMD_ID_LV800B) {
          info->flash_id += FLASH_AM800B;
          info->sector_count = 19;
          info->size = 0x00100000;  /* => 1 MB    */
        }
        else
          if (value == (ushort) AMD_ID_LV160T) {
            info->flash_id += FLASH_AM160T;
            info->sector_count = 35;
            info->size = 0x00200000;  /* => 2 MB    */
          }
          else
            if (value == (ushort) AMD_ID_LV160B) {
              info->flash_id += FLASH_AM160B;
              info->sector_count = 35;
              info->size = 0x00200000;  /* => 2 MB    */
            }
            else
              if (value == (ushort) AMD_ID_LV320T) {
                info->flash_id += FLASH_AM320T;
                info->sector_count = 67;
                info->size = 0x00400000;  /* => 4 MB    */
              }
              else
                if (value == (ushort) AMD_ID_LV320B) {
