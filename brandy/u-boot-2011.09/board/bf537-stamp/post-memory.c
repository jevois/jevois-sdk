...
int post_init_sdram (int sclk)
{
  ...
  if ( (sclk > 119402985) ) {
    ...
    if ( (sclk > 104477612) && (sclk <= 119402985) ) {
      SDRAM_tRP = TRP_2;
      SDRAM_tRP_num = 2;
      SDRAM_tRAS = TRAS_6;
      SDRAM_tRAS_num = 6;
      ...
      if ( (sclk > 89552239) && (sclk <= 104477612) ) {
        SDRAM_tRP = TRP_2;
        SDRAM_tRP_num = 2;
        SDRAM_tRAS = TRAS_5;
        SDRAM_tRAS_num = 5;
        ...
        if ( (sclk > 74626866) && (sclk <= 89552239) ) {
          SDRAM_tRP = TRP_2;
          SDRAM_tRP_num = 2;
          SDRAM_tRAS = TRAS_4;
          SDRAM_tRAS_num = 4;
          ...
          if ( (sclk > 66666667) && (sclk <= 74626866) ) {
            SDRAM_tRP = TRP_2;
            SDRAM_tRP_num = 2;
            SDRAM_tRAS = TRAS_3;
            SDRAM_tRAS_num = 3;
            ...
            if ( (sclk > 59701493) && (sclk <= 66666667) ) {
              ...
              if ( (sclk > 44776119) && (sclk <= 59701493) ) {
                SDRAM_tRP = TRP_1;
                SDRAM_tRP_num = 1;
                SDRAM_tRAS = TRAS_3;
                SDRAM_tRAS_num = 3;
                ...
                if ( (sclk > 29850746) && (sclk <= 44776119) ) {
                  SDRAM_tRP = TRP_1;
                  SDRAM_tRP_num = 1;
                  SDRAM_tRAS = TRAS_2;
                  SDRAM_tRAS_num = 2;
