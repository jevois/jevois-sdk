...
phys_size_t initdram (int board_type)
{
  ...
  { size = 0x20000000; }  /* 512MB */
    ...
    if (setdram (1, 13, 10, 4) == get_ram_size (CONFIG_SYS_SDRAM_BASE, 0x10000000) )
    { size = 0x10000000; }  /* 256MB */
    else
      if (setdram (2, 13, 9, 4) == get_ram_size (CONFIG_SYS_SDRAM_BASE, 0x10000000) )
      { size = 0x10000000; }  /* 256MB */
      else
        if (setdram (1, 13, 9, 4) == get_ram_size (CONFIG_SYS_SDRAM_BASE, 0x08000000) )
        { size = 0x08000000; }  /* 128MB */
        else
          if (setdram (2, 12, 9, 4) == get_ram_size (CONFIG_SYS_SDRAM_BASE, 0x08000000) )
          { size = 0x08000000; }  /* 128MB */
          else
            if (setdram (1, 12, 9, 4) == get_ram_size (CONFIG_SYS_SDRAM_BASE, 0x04000000) )
