                            ...
                            struct tomoyo_profile * profile)
{
  ...
  if (!strcmp (name, "CONFIG") ) {
    ...
    if (tomoyo_str_starts (&name, "CONFIG::") ) {
      config = 0;
                                ...
                                struct tomoyo_acl_info * acl)
{
  ...
  { return false; }
    ...
    if (acl_type == TOMOYO_TYPE_PATH_ACL) {
      ...
      if (acl_type == TOMOYO_TYPE_MANUAL_TASK_ACL) {
          ...
          if (acl_type == TOMOYO_TYPE_PATH2_ACL) {
            ...
            if (acl_type == TOMOYO_TYPE_PATH_NUMBER_ACL) {
              ...
              if (acl_type == TOMOYO_TYPE_MKDEV_ACL) {
                ...
                if (acl_type == TOMOYO_TYPE_INET_ACL) {
                  ...
                  if (acl_type == TOMOYO_TYPE_UNIX_ACL) {
