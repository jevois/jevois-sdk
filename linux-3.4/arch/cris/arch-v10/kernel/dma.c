...
void cris_free_dma (unsigned int dmanr, const char * device_id)
{
  ...
  if (!used_dma_channels[dmanr]) {
    ...
    if (device_id != used_dma_channels_users[dmanr]) {
