      ...
      if (port->use_dma) {
        if (port == &ports[0]) {
          ...
          if (request_irq (DMA_OUT_INTR_VECT,
            ...
            if (request_irq (DMA_IN_INTR_VECT,
                             rx_interrupt,
                             0,
              ...
              if (crisv32_request_dma (OUT_DMA_NBR,
                                       "synchronous serial 0 dma tr",
                ...
                if (crisv32_request_dma (IN_DMA_NBR,
