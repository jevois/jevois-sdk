...
static int __init early_parse_etr (char * p)
{
  ...
  { etr_port0_online = etr_port1_online = 0; }
    ...
    if (strncmp (p, "port0", 5) == 0)
    { etr_port0_online = 1; }
    else
      if (strncmp (p, "port1", 5) == 0)
      { etr_port1_online = 1; }
      else
        if (strncmp (p, "on", 2) == 0)
...
static void etr_steai_cv (struct etr_aib * aib, unsigned int func)
{
  ...
  { aib->esw.psc0 = 2; }
    ...
    if (aib->esw.psc0 == 0 && aib->esw.p == 0)
    { aib->esw.psc0 = 1; }
  if (aib->esw.psc1 == 1)
  { aib->esw.psc1 = 2; }
  else
    if (aib->esw.psc1 == 0 && aib->esw.p == 1)
    { aib->esw.psc1 = 1; }
}
...
static void etr_work_fn (struct work_struct * work)
{
  ...
  if (eacr.p0 && aib.esw.psc0 == etr_lpsc_pps_mode) {
    ...
    { eacr.e1 = 0; }
      ...
      if (etr_port0_uptodate && etr_port1_uptodate)
      { eacr.e1 = 1; }
    ...
    if (eacr.p1 && aib.esw.psc1 == etr_lpsc_pps_mode) {
      ...
      if (eacr.p0 && aib.esw.psc0 == etr_lpsc_operational_step) {
        eacr.sl = 1;
        eacr.e0 = 1;
        ...
        if (eacr.p1 && aib.esw.psc1 == etr_lpsc_operational_step) {
          eacr.sl = 1;
          eacr.e0 = 0;
          eacr.e1 = 1;
          if (!etr_mode_is_etr (etr_eacr) )
