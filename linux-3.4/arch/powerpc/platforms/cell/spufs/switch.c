    ...
    struct spu * spu)
{
  ...
  if ( (csa->prob.spu_status_R & status_P_I) == status_P_I) {
    ...
    if ( (csa->prob.spu_status_R & status_P_H) == status_P_H) {
      ...
      if ( (csa->prob.spu_status_R & status_S_P) == status_S_P) {
        ...
        if ( (csa->prob.spu_status_R & status_S_I) == status_S_I) {
          ...
          if ( (csa->prob.spu_status_R & status_P) == status_P) {
            ...
            if ( (csa->prob.spu_status_R & status_H) == status_H) {
              ...
              if ( (csa->prob.spu_status_R & status_S) == status_S) {
                ...
                if ( (csa->prob.spu_status_R & status_I) == status_I) {
