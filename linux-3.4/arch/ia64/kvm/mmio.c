...
void emulate_io_inst (struct kvm_vcpu * vcpu, u64 padr, u64 ma)
{
  ...
  if (inst.M1.major == 4 && inst.M1.m == 0 && inst.M1.x == 0) {
    ...
    if (inst.M2.major == 4 && inst.M2.m == 1 && inst.M2.x == 0) {
      ...
      if (inst.M3.major == 5) {
        ...
        if (inst.M9.major == 6 && inst.M9.x6 == 0x3B
          ...
          if (inst.M10.major == 7 && inst.M10.x6 == 0x3B) {
            ...
            if (inst.M10.major == 7 && inst.M10.x6 == 0x31) {
              ...
              if (inst.M15.major == 7 && inst.M15.x6 >= 0x2c
                  && inst.M15.x6 <= 0x2f) {
                ...
                if (inst.M12.major == 6 && inst.M12.m == 1
