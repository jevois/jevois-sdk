/*
 * arch/arm/mach-sunxi/include/mach/sun8i/platform-sun8iw3p1.h
 *
...
#ifndef __PLATFORM_SUN8I_W3P1_H
#define __PLATFORM_SUN8I_W3P1_H
...
#define SUNXI_SRAM_VE_PBASE              0x00004000
#define SUNXI_SRAM_VE_SIZE               0x0000C000
...
#define SUNXI_ADDA_PBASE                 0x01c22C00
#define SUNXI_GPADC_PBASE                0x01c25000
...
#define SUNXI_SRAM_VE_VBASE              IO_ADDRESS(SUNXI_SRAM_VE_PBASE      )
...
#define SUNXI_ADDA_VBASE                 IO_ADDRESS(SUNXI_ADDA_PBASE         )
...
#define SUNXI_DRAMCTL1_VBASE             IO_ADDRESS(SUNXI_DRAMCTL1_PBASE     )
