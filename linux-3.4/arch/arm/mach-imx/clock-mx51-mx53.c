  ...
  for_each_compatible_node (np, NULL, "fixed-clock") {
    ...
    { *ckil = rate; }
      ...
      { *osc = rate; }
        ...
        if (of_device_is_compatible (np, "fsl,imx-ckih1") )
        { *ckih1 = rate; }
        else
          if (of_device_is_compatible (np, "fsl,imx-ckih2") )
          { *ckih2 = rate; }
  }
}
