 ...
 *  .lpsc = DAVINCI_LPSC_SCR2, 
 *  .lpsc = DAVINCI_LPSC_SCR3, 
 *  .lpsc = DAVINCI_LPSC_SCR4, 
 *  .lpsc = DAVINCI_LPSC_CROSSBAR, 
 *  .lpsc = DAVINCI_LPSC_CFG27,
 *  .lpsc = DAVINCI_LPSC_CFG3, 
 *  .lpsc = DAVINCI_LPSC_CFG5, 
 */
