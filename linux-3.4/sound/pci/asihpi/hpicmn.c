                               ...
                               struct hpi_message * phm, struct hpi_response * phr)
{
  ...
  case HPI_CONTROL_METER:
    if (phm->u.c.attribute == HPI_METER_PEAK) {
      ...
      if (phm->u.c.attribute == HPI_METER_RMS) {
  ...
  case HPI_CONTROL_VOLUME:
    if (phm->u.c.attribute == HPI_VOLUME_GAIN) {
      ...
      if (phm->u.c.attribute == HPI_VOLUME_MUTE) {
  ...
  case HPI_CONTROL_TUNER:
    ...
    { phr->u.c.param1 = pC->u.tuner.freq_ink_hz; }
      ...
      if (phm->u.c.attribute == HPI_TUNER_BAND)
      { phr->u.c.param1 = pC->u.tuner.band; }
      else
        if (phm->u.c.attribute == HPI_TUNER_LEVEL_AVG)
  ...
  case HPI_CONTROL_SAMPLECLOCK:
    ...
    { phr->u.c.param1 = pC->u.clk.source; }
      ...
      if (phm->u.c.attribute == HPI_SAMPLECLOCK_SOURCE_INDEX) {
        ...
        if (phm->u.c.attribute == HPI_SAMPLECLOCK_SAMPLERATE)
  ...
  case HPI_CONTROL_PAD: {
      ...
      { phr->u.c.param1 = p_pad->pI; }
        ...
        if (phm->u.c.attribute == HPI_PAD_PROGRAM_TYPE)
