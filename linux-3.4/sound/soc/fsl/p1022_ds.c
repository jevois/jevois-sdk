...
static int p1022_ds_probe (struct platform_device * pdev)
{
  ...
  if (strcasecmp (sprop, "i2s-slave") == 0) {
    ...
    if (strcasecmp (sprop, "i2s-master") == 0) {
      mdata->dai_format = SND_SOC_DAIFMT_NB_NF |
      ...
      if (strcasecmp (sprop, "lj-slave") == 0) {
        mdata->dai_format = SND_SOC_DAIFMT_NB_NF |
        ...
        if (strcasecmp (sprop, "lj-master") == 0) {
          mdata->dai_format = SND_SOC_DAIFMT_NB_NF |
          ...
          if (strcasecmp (sprop, "rj-slave") == 0) {
            mdata->dai_format = SND_SOC_DAIFMT_NB_NF |
            ...
            if (strcasecmp (sprop, "rj-master") == 0) {
              mdata->dai_format = SND_SOC_DAIFMT_NB_NF |
              ...
              if (strcasecmp (sprop, "ac97-slave") == 0) {
                mdata->dai_format = SND_SOC_DAIFMT_NB_NF |
                ...
                if (strcasecmp (sprop, "ac97-master") == 0) {
                  mdata->dai_format = SND_SOC_DAIFMT_NB_NF |
