                               ...
                               unsigned int output)
{
  ...
  { fll_div->div = 0x4; }
    ...
    if (output >= 5625000 && output <= 6250000)
    { fll_div->div = 0x3; }
    else
      if (output >= 11250000 && output <= 12500000)
      { fll_div->div = 0x2; }
      else
        if (output >= 22500000 && output <= 25000000)
        { fll_div->div = 0x1; }
        else {
