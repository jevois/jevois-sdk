...
static void earphone_switch_timer_poll (unsigned long data)
{
  ...
  if (!headphone_direct_used) {
    if ( ( (tmp >= 0xb) && (switch_data->mode != FOUR_HEADPHONE_PLUGIN) && (switch_data->state != 2) && (switch_data->reset_flag == 0) ) && (switch_data->mode != HOOK_CHCCK_DOWN) ) {
      ...
      if ( (tmp >= 0x1 && tmp < 0xb) && (switch_data->mode != THREE_HEADPHONE_PLUGIN) && (switch_data->state != 1) && (switch_data->reset_flag == 0) ) {
        SWITCH_DBG ("%s,line:%d,tmp:%x\n", __func__, __LINE__, tmp);
        ...
        if ( (tmp >= 0xb) && (switch_data->mode == FOUR_HEADPHONE_PLUGIN) && (switch_data->state == 1) && (switch_data->reset_flag == 0) ) {
          ...
          if ( (tmp >= 0x10) && (switch_data->reset_flag == 0) ) {
            ...
            if ( (tmp == 0xf) && (switch_data->reset_flag == 0) ) {
          ...
          if ( (tmp < 0xb && tmp > 0) && (switch_data->mode == FOUR_HEADPHONE_PLUGIN) && (switch_data->state == 1) && (switch_data->reset_flag == 0) ) {
            SWITCH_DBG ("%s,line:%d,tmp:%x\n", __func__, __LINE__, tmp);
            /*hook up*/
            ...
            if (switch_data->mode == HOOK_CHCCK_DOWN) {
