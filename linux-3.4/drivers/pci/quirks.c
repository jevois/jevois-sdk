...
static void __init asus_hides_smbus_hostbridge (struct pci_dev * dev)
{
  if (unlikely (dev->subsystem_vendor == PCI_VENDOR_ID_ASUSTEK) ) {
    ...
    if (unlikely (dev->subsystem_vendor == PCI_VENDOR_ID_HP) ) {
      if (dev->device ==  PCI_DEVICE_ID_INTEL_82855PM_HB)
        switch (dev->subsystem_device) {
        ...
        if (dev->device == PCI_DEVICE_ID_INTEL_82865_HB)
          ...
          if (dev->device == PCI_DEVICE_ID_INTEL_82875_HB)
            switch (dev->subsystem_device) {
      ...
      if (unlikely (dev->subsystem_vendor == PCI_VENDOR_ID_SAMSUNG) ) {
        if (dev->device ==  PCI_DEVICE_ID_INTEL_82855PM_HB)
          switch (dev->subsystem_device) {
        ...
        if (unlikely (dev->subsystem_vendor == PCI_VENDOR_ID_COMPAQ) ) {
          if (dev->device == PCI_DEVICE_ID_INTEL_82855PM_HB)
            switch (dev->subsystem_device) {
            ...
            if (dev->device == PCI_DEVICE_ID_INTEL_82810_IG3)
              ...
              if (dev->device == PCI_DEVICE_ID_INTEL_82801DB_2)
                ...
                if (dev->device == PCI_DEVICE_ID_INTEL_82815_CGC)
                  switch (dev->subsystem_device) {
