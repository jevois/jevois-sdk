...
static uint8_t axp_vol_rate(int Bat_Ocv_Vol)
{
    ...
    else if(Bat_Ocv_Vol < FUELGUAGE_LOW_VOL)   
    {
        return FUELGUAGE_LOW_LEVEL;
    }
    else if(Bat_Ocv_Vol < FUELGUAGE_VOL1)      
    {
