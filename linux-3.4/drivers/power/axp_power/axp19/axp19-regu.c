...
static struct axp_regulator_info axp19_regulator_info[] = {
	...
	AXP19_LDO(1,	 3000,	 3000,	 0,	 LDO1,	 0,	 0,	 LDO1EN, 0, 0, 0, 0, 0, 0),	  
	AXP19_LDO(2,	 1800,	 3300,	 100,	 LDO2,	 4,	 4,	 LDO2EN, 2, 0, 0, 0, 0, 0),	  
	AXP19_LDO(3,	 700,	 3500,	 25,	 LDO3,	 0,	 7,	 LDO3EN, 2, 0, 0, 0, 0, 0),	  
	AXP19_LDO(4,	 1800,	 3300,	 100,	 LDO4,	 0,	 4,	 LDO4EN, 3, 0, 0, 0, 0, 0),	  
	AXP19_LDO(IO0,   1800,	 3300,	 100,	 LDOIO0, 4,	 4,	 LDOIOEN,0, 0, 0, 0, 0, 0),	  
};
