...
static struct axp_regulator_info axp_regulator_info[] = {
  AXP15_LDO (1,  700,  3300, 100,  LDO1, 0,  5,  LDO1EN, 5, 0, 0),
  AXP15_LDO (2,  700,  3300, 100,  LDO2, 0,  5,  LDO2EN, 6, 0, 0),
  AXP15_LDO (3,  700,  3300, 100,  LDO3, 0,  5,  LDO3EN, 7, 0, 0),
  AXP15_LDO (4,  700,  1900, 100,  LDO4, 0,  5,  LDO4EN, 0, 0, 0),
  AXP15_LDO (5,  700,  1900, 100,  LDO5, 0,  5,  LDO5EN, 1, 0, 0),
  AXP15_LDO (6,  700,  1900, 100,  LDO6, 0,  5,  LDO6EN, 2, 0, 0),
  AXP15_LDO (7,  700,  1900, 100,  LDO7, 0,  5,  LDO7EN, 3, 0, 0),
  AXP15_LDO (8,  700,  3300, 100,  LDO8, 0,  5,  LDO8EN, 4, 0, 0),
  AXP15_LDO (9,  700,  4200, 100,  LDO9, 0,  5,  LDO9EN, 5, 3400, 200),
  AXP15_LDO (10, 700,  3300, 100,  LDO10,  0,  5,  LDO10EN, 6, 0, 0),
  ...
  AXP15_SW (0, 700,  3300, 100,  SW0,  0,  0,  SW0EN, 7, 0, 0),
};
  ...
  if (info->desc.id == AXP15_ID_DCDC1) {
    ...
    if (info->desc.id == AXP15_ID_DCDC2) {
      ...
      if (info->desc.id == AXP15_ID_DCDC3) {
        ...
        if (info->desc.id == AXP15_ID_DCDC4) {
          switch (val & 0x02) {
          case 0: return sprintf (buf, "AUTO\n");
          case 2: return sprintf (buf, "PWM\n");
          default: return sprintf (buf, "UNKNOWN\n");
          ...
          if (info->desc.id == AXP15_ID_DCDC5) {
            switch (val & 0x02) {
            case 0: return sprintf (buf, "AUTO\n");
            case 2: return sprintf (buf, "PWM\n");
            default: return sprintf (buf, "UNKNOWN\n");
