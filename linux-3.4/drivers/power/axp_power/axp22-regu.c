...
static struct axp_regulator_info axp_regulator_info[] = {
  AXP22_LDO (1,  AXP22LDO1,  AXP22LDO1,  0,  LDO1, 0,  0,  LDO1EN, 0, 0, 0, 0),
  AXP22_LDO (2,  700,  3300, 100,  LDO2, 0,  5,  LDO2EN, 6, 0, 0, 0),
  AXP22_LDO (3,  700,  3300, 100,  LDO3, 0,  5,  LDO3EN, 7, 0, 0, 0),
  #ifdef CONFIG_AXP809
  AXP22_LDO (4,  700,  3300, 100,  LDO4, 0,  5,  LDO4EN, 5, 0, 0, 0),
  AXP22_LDO (5,  700,  4200, 100,  LDO5, 0,  5,  LDO5EN, 3, 3400, 200, 0),
  #else
  AXP22_LDO (4,  700,  3300, 100,  LDO4, 0,  5,  LDO4EN, 7, 0, 0, 0),
  AXP22_LDO (5,  700,  3300, 100,  LDO5, 0,  5,  LDO5EN, 3, 0, 0, 0),
  #endif
  AXP22_LDO (6,  700,  3300, 100,  LDO6, 0,  5,  LDO6EN, 4, 0, 0, 0),
  AXP22_LDO (7,  700,  3300, 100,  LDO7, 0,  5,  LDO7EN, 5, 0, 0, 0),
  AXP22_LDO (8,  700,  3300, 100,  LDO8, 0,  5,  LDO8EN, 6, 0, 0, 0),
  AXP22_LDO (9,  700,  3300, 100,  LDO9, 0,  5,  LDO9EN, 0, 0, 0, 0),
  AXP22_LDO (10, 700,  3300, 100,  LDO10,  0,  5,  LDO10EN, 1, 0, 0, 0),
  AXP22_LDO (11, 700,  3300, 100,  LDO11,  0,  5,  LDO11EN, 2, 0, 0, 0),
  AXP22_LDO (12, 700,  3300, 100,  LDO12,  0,  3,  LDO12EN, 0, 0, 0, 0),
  AXP22_DCDC (1, 1600, 3400, 100,  DCDC1,  0,  5,  DCDC1EN, 1, 0, 0, 0),
  AXP22_DCDC (2, 600,  1540, 20, DCDC2,  0,  6,  DCDC2EN, 2, 0, 0, 0),
  AXP22_DCDC (3, 600,  1860, 20, DCDC3,  0,  6,  DCDC3EN, 3, 0, 0, 0),
  #ifdef CONFIG_AXP809
  AXP22_DCDC (4, 600,  2600, 20, DCDC4,  0,  6,  DCDC4EN, 4, 1540, 100, 1800),
  #else
  AXP22_DCDC (4, 600,  1540, 20, DCDC4,  0,  6,  DCDC4EN, 4, 0, 0, 0),
  #endif
  AXP22_DCDC (5, 1000, 2550, 50, DCDC5,  0,  5,  DCDC5EN, 5, 0, 0, 0),
  AXP22_LDO (IO0,  700,  3300, 100,  LDOIO0, 0,  5,  LDOIO0EN, 0, 0, 0, 0),
  AXP22_LDO (IO1,  700,  3300, 100,  LDOIO1, 0,  5,  LDOIO1EN, 0, 0, 0, 0),
  #ifdef CONFIG_AXP809
  AXP22_SW (0, 700,  3300, 100,  SW0,  0,  0,  SW0EN, 6, 0, 0, 0),
  #endif
  AXP22_SW (1, 700,  3300, 100,  DC1SW,  0,  0,  DC1SWEN, 7, 0, 0, 0),
};
                              ...
                              struct device_attribute * attr, char * buf)
{
  ...
  if (info->desc.id == AXP22_ID_DCDC1) {
    ...
    if (info->desc.id == AXP22_ID_DCDC2) {
      switch (val & 0x02) {
      case 0: return sprintf (buf, "AUTO\n");
      ...
      if (info->desc.id == AXP22_ID_DCDC3) {
        switch (val & 0x02) {
        case 0: return sprintf (buf, "AUTO\n");
        case 2: return sprintf (buf, "PWM\n");
        default: return sprintf (buf, "UNKNOWN\n");
        ...
        if (info->desc.id == AXP22_ID_DCDC4) {
          switch (val & 0x02) {
          case 0: return sprintf (buf, "AUTO\n");
          case 2: return sprintf (buf, "PWM\n");
          default: return sprintf (buf, "UNKNOWN\n");
          ...
          if (info->desc.id == AXP22_ID_DCDC5) {
            switch (val & 0x02) {
            case 0: return sprintf (buf, "AUTO\n");
            case 2: return sprintf (buf, "PWM\n");
            default: return sprintf (buf, "UNKNOWN\n");
