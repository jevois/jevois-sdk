...
static struct axp_regulator_info axp81x_regulator_info[] = {
  ...
  AXP81X_LDO (1,  3000,   3000,   0,  LDO1,   0,  0,  LDO1EN, 5, 0, 0, 0, 0, 0),  
  AXP81X_LDO (2,  700,  3300,   100,  LDO2,   0,  5,  LDO2EN, 5, 0, 0, 0, 0, 0),  
  AXP81X_LDO (3,  700,  3300,   100,  LDO3,   0,  5,  LDO3EN, 6, 0, 0, 0, 0, 0),  
  AXP81X_LDO (4,  700,  3300,   100,  LDO4,   0,  5,  LDO4EN, 7, 0, 0, 0, 0, 0),  
  AXP81X_LDO (5,  700,  3300,   100,  LDO5,   0,  5,  LDO5EN, 3, 0, 0, 0, 0, 0),  
  AXP81X_LDO (6,  700,  4200,   100,  LDO6,   0,  5,  LDO6EN, 4, 3400, 200, 0, 0, 0), 
  AXP81X_LDO (7,  700,  3300,   100,  LDO7,   0,  5,  LDO7EN, 5, 0, 0, 0, 0, 0),  
  AXP81X_LDO (8,  700,  3300,   100,  LDO8,   0,  5,  LDO8EN, 6, 0, 0, 0, 0, 0),  
  AXP81X_LDO (9,  700,  1900,   50,   LDO9,   0,  5,  LDO9EN, 0, 0, 0, 0, 0, 0),  
  AXP81X_LDO (10,   700,  1900,   50,   LDO10,  0,  5,  LDO10EN, 1, 0, 0, 0, 0, 0),   
  AXP81X_LDO (11,   700,  1900,   50,   LDO11,  0,  5,  LDO11EN, 2, 0, 0, 0, 0, 0), 
  AXP81X_LDO (12,   700,  1450,   50,   LDO12,  0,  4,  LDO12EN, 2, 0, 0, 0, 0, 0), 
  AXP81X_LDO (13,   700,  1450,   50,   LDO13,  0,  4,  LDO13EN, 3, 0, 0, 0, 0, 0), 
  AXP81X_LDO (IO0,  700,  3300,   100,  LDOIO0, 0,  5,  LDOIO0EN, 0, 0, 0, 0, 0, 0),  
  AXP81X_LDO (IO1,  700,  3300,   100,  LDOIO1, 0,  5,  LDOIO1EN, 0, 0, 0, 0, 0, 0),  
  AXP81X_SW (0,  1600, 3400, 100,   DC1SW, 0,  0,   DC1SWEN, 7, 0, 0, 0, 0, 0),
};
