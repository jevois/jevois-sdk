...
static struct axp_regulator_info axp20_regulator_info[] = {
  ...
  AXP20_LDO (1,   3300,    3300, 0,   LDO1,   0,  0,  LDO1EN, 0, 0, 0, 0, 0, 0),  
  AXP20_LDO (2,   1800,    3300,  100,  LDO2,   4,  4,  LDO2EN, 2, 0, 0, 0, 0, 0),  
  AXP20_LDO (3,   700,   3500,  25,   LDO3,   0,  7,  LDO3EN, 6, 0, 0, 0, 0, 0),  
  AXP20_LDO (4,   1250,    3300,  0,  LDO4,   0,  4,  LDO4EN, 3, 0, 0, 0, 0, 0),  
  AXP20_LDO (IO0,   1800,    3300,  100,  LDOIO0, 4,  4,  LDOIOEN, 0, 0, 0, 0, 0, 0), 
...
struct axp_funcdev_info * axp20_regu_init (void)
{
  ...
  for (i = 0; i < ARRAY_SIZE (axp20_regulator_info); i ++)
  {
    ...
    { axp20_regulator_info[i].desc.ops = &axp20_ldo4_ops; }
      ...
      if (axp20_regulator_info[i].desc.id == AXP20_ID_LDOIO0)
