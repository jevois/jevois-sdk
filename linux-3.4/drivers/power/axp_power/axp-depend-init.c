...
static int axp81x_regu_dependence (const char * ldo_name)
{
  ...
  if (strcmp ("axp81x_dcdc1", ldo_name) == 0) {
    ...
    if (strcmp ("axp81x_dcdc2", ldo_name) == 0) {
      axp81x_dependence |= AXP803_813_DCDC2;
    }
    else
      if (strcmp ("axp81x_dcdc3", ldo_name) == 0) {
        axp81x_dependence |= AXP803_813_DCDC3;
      }
      else
        if (strcmp ("axp81x_dcdc4", ldo_name) == 0) {
          axp81x_dependence |= AXP803_813_DCDC4;
        }
        else
          if (strcmp ("axp81x_dcdc5", ldo_name) == 0) {
            axp81x_dependence |= AXP803_813_DCDC5;
          }
          else
            if (strcmp ("axp81x_dcdc6", ldo_name) == 0) {
              axp81x_dependence |= AXP803_813_DCDC6;
            }
            else
              if (strcmp ("axp81x_dcdc7", ldo_name) == 0) {
                axp81x_dependence |= AXP803_813_DCDC7;
              }
              else
                if (strcmp ("axp81x_aldo1", ldo_name) == 0) {
                  axp81x_dependence |= AXP803_813_ALDO1;
                }
                else
                  if (strcmp ("axp81x_aldo2", ldo_name) == 0) {
                    axp81x_dependence |= AXP803_813_ALDO2;
                  }
                  else
                    if (strcmp ("axp81x_aldo3", ldo_name) == 0) {
                      axp81x_dependence |= AXP803_813_ALDO3;
                    }
                    else
                      if (strcmp ("axp81x_dldo1", ldo_name) == 0) {
                        axp81x_dependence |= AXP803_813_DLDO1;
                      }
                      else
                        if (strcmp ("axp81x_dldo2", ldo_name) == 0) {
                          axp81x_dependence |= AXP803_813_DLDO2;
                        }
                        else
                          if (strcmp ("axp81x_dldo3", ldo_name) == 0) {
                            axp81x_dependence |= AXP803_813_DLDO3;
                          }
                          else
                            if (strcmp ("axp81x_dldo4", ldo_name) == 0) {
                              axp81x_dependence |= AXP803_813_DLDO4;
                            }
                            else
                              if (strcmp ("axp81x_eldo1", ldo_name) == 0) {
                                axp81x_dependence |= AXP803_813_ELDO1;
                              }
                              else
                                if (strcmp ("axp81x_eldo2", ldo_name) == 0) {
                                  axp81x_dependence |= AXP803_813_ELDO2;
                                }
                                else
                                  if (strcmp ("axp81x_eldo3", ldo_name) == 0) {
                                    axp81x_dependence |= AXP803_813_ELDO3;
                                  }
                                  else
                                    if (strcmp ("axp81x_fldo1", ldo_name) == 0) {
                                      axp81x_dependence |= AXP803_813_FLDO1;
                                    }
                                    else
                                      if (strcmp ("axp81x_fldo2", ldo_name) == 0) {
                                        axp81x_dependence |= AXP803_813_FLDO2;
                                      }
                                      else
                                        if (strcmp ("axp81x_gpio0ldo", ldo_name) == 0) {
                                          axp81x_dependence |= AXP803_813_LDOIO0;
                                        }
                                        else
                                          if (strcmp ("axp81x_gpio1ldo", ldo_name) == 0) {
                                            axp81x_dependence |= AXP803_813_LDOIO1;
                                          }
                                          else
                                            if (strcmp ("axp81x_dc1sw", ldo_name) == 0) {
                                              axp81x_dependence |= AXP803_813_DC1SW;
                                            }
                                            else
                                              if (strcmp ("axp81x_rtc", ldo_name) == 0) {
...
static int axp20_regu_dependence (const char * ldo_name)
{
  ...
  if (strcmp ("axp20_dcdc2", ldo_name) == 0) {
    ...
    if (strcmp ("axp20_dcdc3", ldo_name) == 0) {
      axp20_dependence |= AXP209_DCDC3;
    }
    else
      if (strcmp ("axp20_ldo1", ldo_name) == 0) {
        axp20_dependence |= AXP209_LDO1;
      }
      else
        if (strcmp ("axp20_ldo2", ldo_name) == 0) {
          axp20_dependence |= AXP209_LDO2;
        }
        else
          if (strcmp ("axp20_ldo3", ldo_name) == 0) {
            axp20_dependence |= AXP209_LDO3;
          }
          else
            if (strcmp ("axp20_ldo4", ldo_name) == 0) {
              axp20_dependence |= AXP209_LDO4;
            }
            else
              if (strcmp ("axp20_ldoio0", ldo_name) == 0) {
