...
static unsigned long calc_rate_pll3 (u32 parent_rate, struct clk_factors_value * factor)
{
  ...
  { return 22579200; }
    ...
    if ( (factor->factorn == 61) && (factor->factord1 == 0) && (factor->factord2 == 1) && (factor->factorp == 29) )
    { return 24576000; }
    else
    {
      tmp_rate = tmp_rate * (factor->factorn);
...
static const char * ahb_parents[]    = {"gt", "pll4", "pll12", "pll12"};
static const char * apb_parents[]    = {"hosc", "pll4"};         
static const char * cci400_parents[]    = {"hosc", "pll4", "pll12", "pll12"};
static const char * ats_parents[]    = {"hosc", "pll4", "", ""};
static const char * outa_parents[]   = {"hosc_750", "losc", "hosc", ""};
static const char * outb_parents[]   = {"hosc_750", "losc", "hosc", ""};
static const char * storage_parents[] = {"hosc", "pll4", "", "",  "", "", "", "",  "", "", "", "",  "", "", "", ""};
static const char * ss_parents[] = {"hosc", "pll4", "", "",  "", "", "", "",  "", "", "", "",  "", "pll12", "", ""};
static const char * audio_parents[]  = {"pll3"};
static const char * sdr_parents[]    = {"pll4", "", "", "pll6",  "", "", "", "",  "", "", "", "",  "", "", "", ""};
static const char * de_parents[]     = {"pll10"};
static const char * mp_parents[]     = {"", "", "", "",  "", "", "", "",  "", "pll8", "pll9", "pll10",  "", "", "", ""};
static const char * display_parents[] = {"", "", "", "",  "", "", "", "",  "pll7", "pll8", "", "",  "", "", "", ""};
static const char * mipidsi1_parents[] = {"hosc", "", "", "",  "", "", "", "",  "", "pll8", "", "",  "", "", "", ""};
static const char * csi_parents[]    = {"hosc", "", "", "",  "", "", "", "",  "", "pll8", "", "",  "", "", "", ""};
static const char * fd_parents[]    = {"", "pll4", "", "", "", "", "", "", "", "", "", "",  "pll11", "", "", ""};
static const char * ve_parents[]     = {"pll5"};
static const char * gpu_parents[]    = {"pll9"};
static const char * gpuaxi_parents[] = {"", "pll4", "", "", "", "", "", "", "", "", "pll9", "", "", "", "", ""};
static const char * sata_parents[]   = {"pll4"};
static const char * mipihsi_parents[] = {"hosc", "pll4", "", "",  "", "", "", "",  "", "", "", "",  "", "", "", ""};
static const char * gpadc_parents[]  = {"hosc", "", "", "",  "pll3", "", "", "losc",  "", "", "", "",  "", "", "", ""};
static const char * cirtx_parents[]  = {"hosc", "", "", "",  "", "", "", "losc",  "", "", "", "",  "", "", "", ""};
