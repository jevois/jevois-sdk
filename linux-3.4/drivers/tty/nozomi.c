                        ...
                        u32 size_bytes)
{
  ...
  case 2: /* 2 bytes */
    ...
    break;
  case 1: /*
     * also needs to write 4 bytes in this case      * so falling through..
     */
  case 4: /* 4 bytes */
...
static int receive_flow_control (struct nozomi * dc)
{
  ...
  if (old_ctrl.CTS == 1 && ctrl_dl.CTS == 0) {
    ...
    if (old_ctrl.CTS == 0 && ctrl_dl.CTS == 1) {
