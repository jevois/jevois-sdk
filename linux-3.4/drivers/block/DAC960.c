...
static void DAC960_V1_ProcessCompletedCommand (DAC960_Command_T * Command)
{
      ...
      CommandType == DAC960_WriteCommand)
  {
    ...
    if (CommandStatus == DAC960_V1_NormalCompletion) {
      ...
      if (CommandStatus == DAC960_V1_IrrecoverableDataError ||
    ...
    if (CommandType == DAC960_ReadRetryCommand ||
      ...
      */
      ...
      if (CommandType == DAC960_MonitoringCommand)
      {
        ...
        if (CommandOpcode == DAC960_V1_Enquiry)
        {
          ...
          if (CommandOpcode == DAC960_V1_PerformEventLogOperation)
          {
            static char
            *DAC960_EventMessages[] =
                ...
                Controller->V1.OldEventLogSequenceNumber)
            {
              ...
              if (SenseKey == DAC960_SenseKey_VendorSpecific &&
                ...
                if (SenseKey == DAC960_SenseKey_UnitAttention &&
                    AdditionalSenseCode == 0x29)
                {
                  ...
                  if (! (SenseKey == DAC960_SenseKey_NoSense ||
            ...
            if (CommandOpcode == DAC960_V1_GetErrorTable)
            {
              ...
              if (CommandOpcode == DAC960_V1_GetDeviceState)
              {
                ...
                if (CommandOpcode == DAC960_V1_GetLogicalDriveInformation)
                {
                  ...
                  if (CommandOpcode == DAC960_V1_GetRebuildProgress)
                  {
                    ...
                    if (CommandOpcode == DAC960_V1_RebuildStat)
                    {
                      unsigned int LogicalDriveNumber =
                        Controller->V1.RebuildProgress->LogicalDriveNumber;
                      unsigned int LogicalDriveSize =
                      ...
                      if (CommandOpcode == DAC960_V1_BackgroundInitializationControl)
                      {
                        unsigned int LogicalDriveNumber =
...
static void DAC960_V2_ProcessCompletedCommand (DAC960_Command_T * Command)
{
      ...
      CommandType == DAC960_WriteCommand)
  {
    ...
    if (CommandStatus == DAC960_V2_NormalCompletion) {
      ...
      if (Command->V2.RequestSense->SenseKey == DAC960_SenseKey_MediumError)
      {
        /*
         * break the command down into pieces and resubmit each
         * piece, hoping that some of them will succeed.
      ...
      */
      ...
      if (CommandType == DAC960_MonitoringCommand)
      {
        ...
        if (IOCTLOpcode == DAC960_V2_GetControllerInfo)
        {
          ...
          if (IOCTLOpcode == DAC960_V2_GetEvent)
          {
            if (CommandStatus == DAC960_V2_NormalCompletion) {
            ...
            if (IOCTLOpcode == DAC960_V2_GetPhysicalDeviceInfoValid &&
                CommandStatus == DAC960_V2_NormalCompletion)
            {
              ...
              if (IOCTLOpcode == DAC960_V2_GetPhysicalDeviceInfoValid)
              {
                ...
                if (IOCTLOpcode == DAC960_V2_GetLogicalDeviceInfoValid &&
                    CommandStatus == DAC960_V2_NormalCompletion)
                {
                  DAC960_V2_LogicalDeviceInfo_T * NewLogicalDeviceInfo =
                    Controller->V2.NewLogicalDeviceInformation;
                  ...
                  if (LogicalDeviceInfo != NULL)
                  {
                    ...
                    if (NewLogicalDeviceInfo->ConsistencyCheckInProgress)
                      ...
                      if (NewLogicalDeviceInfo->RebuildInProgress)
                        DAC960_V2_ReportProgress (Controller,
                                                  "Rebuild",
                                                  LogicalDeviceNumber,
                                                  NewLogicalDeviceInfo
                        ...
                        if (NewLogicalDeviceInfo->BackgroundInitializationInProgress)
                          DAC960_V2_ReportProgress (Controller,
                          ...
                          if (NewLogicalDeviceInfo->ForegroundInitializationInProgress)
                            DAC960_V2_ReportProgress (Controller,
                            ...
                            if (NewLogicalDeviceInfo->DataMigrationInProgress)
                              DAC960_V2_ReportProgress (Controller,
                                                        "Data Migration",
                                                        LogicalDeviceNumber,
                                                        NewLogicalDeviceInfo
                              ...
                              if (NewLogicalDeviceInfo->PatrolOperationInProgress)
                                DAC960_V2_ReportProgress (Controller,
                                                          "Patrol Operation",
                                                          LogicalDeviceNumber,
                                                          NewLogicalDeviceInfo
                  ...
                  if (IOCTLOpcode == DAC960_V2_GetLogicalDeviceInfoValid)
                  {
                    ...
                    if (CommandOpcode == DAC960_V2_SCSI_10_Passthru)
                    {
                      DAC960_SCSI_Inquiry_UnitSerialNumber_T * InquiryUnitSerialNumber =
                            ...
                            ...)
{
  ...
  if (Controller == NULL)
        ...
        MessageLevel == DAC960_InfoLevel)
    {
      ...
      if (MessageLevel == DAC960_ProgressLevel)
      {
        ...
        if (MessageLevel == DAC960_UserCriticalLevel)
        {
    ...
    unsigned char * UserCommand)
{
  ...
  if (strcmp (UserCommand, "flush-cache") == 0)
  {
    ...
    if (strncmp (UserCommand, "kill", 4) == 0 &&
                                    ...
                                    &Channel, &TargetID) )
    {
      ...
      if (strncmp (UserCommand, "make-online", 11) == 0 &&
                                      ...
                                      &Channel, &TargetID) )
      {
        ...
        if (strncmp (UserCommand, "make-standby", 12) == 0 &&
                                        ...
                                        &Channel, &TargetID) )
        {
          ...
          if (strncmp (UserCommand, "rebuild", 7) == 0 &&
                                          ...
                                          &Channel, &TargetID) )
          {
            ...
            if (strncmp (UserCommand, "check-consistency", 17) == 0 &&
                                          ...
                                          &LogicalDriveNumber) )
            {
              ...
              if (strcmp (UserCommand, "cancel-rebuild") == 0 ||
                                             ...
                                             &LogicalDeviceNumber) )
      {
                                               ...
                                               &LogicalDeviceNumber) )
        {
                                                 ...
                                                 &LogicalDeviceNumber) )
          {
            ...
            if (strncmp (UserCommand, "cancel-rebuild", 14) == 0 &&
                                                   ...
                                                   &LogicalDeviceNumber) )
            {
                                            ...
                                            &LogicalDriveNumber) )
              {
                ...
                if (strncmp (UserCommand, "cancel-consistency-check", 24) == 0 &&
                                              ...
                                              &LogicalDriveNumber) )
                {
                  ...
                  if (strcmp (UserCommand, "perform-discovery") == 0)
                  {
                    ...
                    if (strcmp (UserCommand, "suppress-enclosure-messages") == 0)
