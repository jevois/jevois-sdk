 ...
 *         PTX_TS_RECORD    pTxTs
 *  output:  none
 *  notice:  As PTX_TS_RECORD structure will be defined in QOS, so wait to be merged.
********************************************************************************************************************/
 ...
 *         PRX_TS_RECORD    pRxTs
 *  output:  none
 *  notice:  As PRX_TS_RECORD structure will be defined in QOS, so wait to be merged.
********************************************************************************************************************/
...
int ieee80211_rx_ADDBARsp ( struct ieee80211_device * ieee, struct sk_buff * skb)
{
  ...
  if ( (pAdmittedBA->bValid == true) )
  {
    ...
    if ( (pPendingBA->bValid == false) || (*pDialogToken != pPendingBA->DialogToken) )
    {
