                                     ...
                                     char * start, char * stop)
{
  ...
  if ( (r8712_is_cckratesonly_included ( (u8 *) &pnetwork->network.
    ...
    if ( (r8712_is_cckrates_included ( (u8 *) &pnetwork->network.
                                       SupportedRates) ) == true) {
      if (ht_cap == true)
                              ...
                              union iwreq_data * wrqu, char * extra)
{
  ...
  if (check_fwstate (pmlmepriv, _FW_LINKED | WIFI_ADHOC_MASTER_STATE) ==
    ...
    if (r8712_is_cckratesonly_included ( (u8 *) prates) == true) {
      ...
      if ( (r8712_is_cckrates_included ( (u8 *) prates) ) == true) {
        if (ht_cap == true)
          snprintf (wrqu->name, IFNAMSIZ,
                    "IEEE 802.11bgn");
        else
  ...
  if (0 == strcasecmp (ext, "RSSI") ) {
    ...
    if (0 == strcasecmp (ext, "LINKSPEED") ) {
      ...
      if (0 == strcasecmp (ext, "MACADDR") ) {
        ...
        if (0 == strcasecmp (ext, "SCAN-ACTIVE") ) {
          ...
          if (0 == strcasecmp (ext, "SCAN-PASSIVE") ) {
                            ...
                            union iwreq_data * wrqu, char * extra)
{
  ...
  if (u32wps_start == 1) /* WPS Start */
    ...
    if (u32wps_start == 2) /* WPS Stop because of wps success */
      padapter->ledpriv.LedControlHandler (padapter,
                                           LED_CTL_STOP_WPS);
    else
      if (u32wps_start == 3) /* WPS Stop because of wps fail */
        padapter->ledpriv.LedControlHandler (padapter,
