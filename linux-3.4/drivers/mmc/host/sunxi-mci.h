...
#define SDXC_REG_FIFO ( REG_FIFO_OS )
...
#define SDXC_ACKRcv   BIT(8) 
#define SDXC_DataTimeout  BIT(9) 
#define SDXC_BootStart    BIT(9) 
#define SDXC_DataStarve   BIT(10)
...
#define SDXC_IntErrBit    (SDXC_RespErr | SDXC_RespCRCErr | SDXC_DataCRCErr \
                           ...
                           | SDXC_HardWLocked | SDXC_StartBitErr | SDXC_EndBitErr) 
/* status */
...
#ifdef CONFIG_ARCH_SUN9IW1
#define SDXC_RET_SW (1<<18)
#define SDXC_CLK_SW (1<<16)
#endif
...
#define CARD_DETECT_BY_GPIO_IRQ_UP  (6)
  u32 power_on: 8;
  u32 read_only: 8;
  u32 io_flag: 8;
  u32 suspend: 8;
