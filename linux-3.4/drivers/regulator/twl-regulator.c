                         ...
                         unsigned int * selector)
{
  ...
  case 0:
    ...
    { vsel = 0; }
      ...
      if ( (min_uV >= 600000) && (min_uV <= 1300000) ) {
        int calc_uV;
       ...
       */
        ...
        if ( (min_uV > 1900000) && (max_uV >= 2100000) )
        { vsel = 62; }
        else
          if ( (min_uV > 1800000) && (max_uV >= 1900000) )
          { vsel = 61; }
          else
            if ( (min_uV > 1500000) && (max_uV >= 1800000) )
            { vsel = 60; }
            else
              if ( (min_uV > 1350000) && (max_uV >= 1500000) )
              { vsel = 59; }
              else
                if ( (min_uV > 1300000) && (max_uV >= 1350000) )
                { vsel = 58; }
                else
                { return -EINVAL; }
    break;
  case SMPS_OFFSET_EN:
    ...
    { vsel = 0; }
      ...
      if ( (min_uV >= 700000) && (min_uV <= 1420000) ) {
        int calc_uV;
       ...
       */
        ...
        { vsel = 62; }
          ...
          { vsel = 61; }
            ...
            if ( (min_uV > 1350000) && (max_uV >= 1800000) )
            { vsel = 60; }
            else
              if ( (min_uV > 1350000) && (max_uV >= 1500000) )
              { vsel = 59; }
  ...
  case SMPS_EXTENDED_EN:
    ...
    { vsel = 0; }
      ...
      if ( (min_uV >= 1852000) && (max_uV <= 4013600) ) {
  ...
  case SMPS_OFFSET_EN|SMPS_EXTENDED_EN:
    ...
    { vsel = 0; }
      ...
      if ( (min_uV >= 2161000) && (max_uV <= 4321000) ) {
