...
struct vfe_ctrl_para {
  ...
  unsigned int                            vflip; 
  unsigned int                            hflip; 
  enum v4l2_power_line_frequency          band_stop_mode;
  unsigned int                            auto_hue;
  unsigned int                            wb_temperature;
  int                                     sharpness;
  unsigned int                            chroma_agc;
  enum v4l2_colorfx                       colorfx;
  unsigned int                            auto_brightness;
  unsigned int                            band_stop_filter;
  unsigned int                            illuminator1;
  unsigned int                            illuminator2;
  enum  v4l2_exposure_auto_type           exp_auto_mode;
  unsigned int                            exp_abs;
  unsigned int                            exp_auto_pri;
  unsigned int                            focus_abs;
  unsigned int                            focus_rel;
  unsigned int                            auto_focus;
  unsigned int                            exp_bias;
  enum v4l2_auto_n_preset_white_balance   wb_preset;
  unsigned int                            wdr; 
  unsigned int                            image_stabl;
  unsigned int                            iso;
  enum v4l2_iso_sensitivity_auto_type     iso_mode;
  enum v4l2_exposure_metering             exp_metering;
  enum v4l2_scene_mode                    scene_mode;
  unsigned int                            ae_lock;
  unsigned int                            awb_lock;
  unsigned int                            af_lock;
  unsigned int                            af_status_cur; 
  unsigned int                            af_status_next; 
  enum v4l2_auto_focus_range              af_range;
