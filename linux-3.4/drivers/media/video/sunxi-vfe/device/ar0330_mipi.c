...
static int sensor_s_gain (struct v4l2_subdev * sd, int gain_val)
{
  ...
  { sensor_write (sd, 0x3060, 0x0000); }
    ...
    if ( (103 * 16) <= gain_val * 100 && gain_val * 100 < (107 * 16) )
    { sensor_write (sd, 0x3060, 0x0001); }
    else
      if ( (107 * 16) <= gain_val * 100 && gain_val * 100 < (110 * 16) )
      { sensor_write (sd, 0x3060, 0x0002); }
      else
        if ( (110 * 16) <= gain_val * 100 && gain_val * 100 < (114 * 16) )
        { sensor_write (sd, 0x3060, 0x0003); }
        else
          if ( (114 * 16) <= gain_val * 100 && gain_val * 100 < (119 * 16) )
          { sensor_write (sd, 0x3060, 0x0004); }
          else
            if ( (119 * 16) <= gain_val * 100 && gain_val * 100 < (123 * 16) )
            { sensor_write (sd, 0x3060, 0x0005); }
            else
              if ( (123 * 16) <= gain_val * 100 && gain_val * 100 < (128 * 16) )
              { sensor_write (sd, 0x3060, 0x0006); }
              else
                if ( (128 * 16) <= gain_val * 100 && gain_val * 100 < (133 * 16) )
                { sensor_write (sd, 0x3060, 0x0007); }
                else
                  if ( (133 * 16) <= gain_val * 100 && gain_val * 100 < (139 * 16) )
                  { sensor_write (sd, 0x3060, 0x0008); }
                  else
                    if ( (139 * 16) <= gain_val * 100 && gain_val * 100 < (145 * 16) )
                    { sensor_write (sd, 0x3060, 0x0009); }
                    else
                      if ( (145 * 16) <= gain_val * 100 && gain_val * 100 < (152 * 16) )
                      { sensor_write (sd, 0x3060, 0x000a); }
                      else
                        if ( (152 * 16) <= gain_val * 100 && gain_val * 100 < (160 * 16) )
                        { sensor_write (sd, 0x3060, 0x000b); }
                        else
                          if ( (160 * 16) <= gain_val * 100 && gain_val * 100 < (168 * 16) )
                          { sensor_write (sd, 0x3060, 0x000c); }
                          else
                            if ( (168 * 16) <= gain_val * 100 && gain_val * 100 < (178 * 16) )
                            { sensor_write (sd, 0x3060, 0x000d); }
                            else
                              if ( (178 * 16) <= gain_val * 100 && gain_val * 100 < (188 * 16) )
                              { sensor_write (sd, 0x3060, 0x000e); }
                              else
                                if ( (188 * 16) <= gain_val * 100 && gain_val * 100 < (200 * 16) )
                                { sensor_write (sd, 0x3060, 0x000f); }
                                else
                                  if ( (200 * 16) <= gain_val * 100 && gain_val * 100 < (213 * 16) )
                                  {
                                    sensor_write (sd, 0x3060, 0x0010);
                                    dig_gain = gain_val * 12800 / (200 * 16);
                                  }
                                  else
                                    if ( (213 * 16) <= gain_val * 100 && gain_val * 100 < (229 * 16) )
                                    {
                                      sensor_write (sd, 0x3060, 0x0012);
                                      dig_gain = gain_val * 12800 / (213 * 16);
                                    }
                                    else
                                      if ( (229 * 16) <= gain_val * 100 && gain_val * 100 < (246 * 16) )
                                      {
                                        sensor_write (sd, 0x3060, 0x0014);
                                        dig_gain = gain_val * 12800 / (229 * 16);
                                      }
                                      else
                                        if ( (246 * 16) <= gain_val * 100 && gain_val * 100 < (267 * 16) )
                                        {
                                          sensor_write (sd, 0x3060, 0x0016);
                                          dig_gain = gain_val * 12800 / (246 * 16);
                                        }
                                        else
                                          if ( (267 * 16) <= gain_val * 100 && gain_val * 100 < (291 * 16) )
                                          {
                                            sensor_write (sd, 0x3060, 0x0018);
                                            dig_gain = gain_val * 12800 / (267 * 16);
                                          }
                                          else
                                            if ( (291 * 16) <= gain_val * 100 && gain_val * 100 < (320 * 16) )
                                            {
                                              sensor_write (sd, 0x3060, 0x001a);
                                              dig_gain = gain_val * 12800 / (291 * 16);
                                            }
                                            else
                                              if ( (320 * 16) <= gain_val * 100 && gain_val * 100 < (356 * 16) )
                                              {
                                                sensor_write (sd, 0x3060, 0x001c);
                                                dig_gain = gain_val * 12800 / (320 * 16);
                                              }
                                              else
                                                if ( (356 * 16) <= gain_val * 100 && gain_val * 100 < (400 * 16) )
                                                {
                                                  sensor_write (sd, 0x3060, 0x001e);
                                                  dig_gain = gain_val * 12800 / (356 * 16);
                                                }
                                                else
                                                  if ( (400 * 16) <= gain_val * 100 && gain_val * 100 < (457 * 16) )
                                                  {
                                                    sensor_write (sd, 0x3060, 0x0020);
                                                    dig_gain = gain_val * 12800 / (400 * 16);
                                                  }
                                                  else
                                                    if ( (457 * 16) <= gain_val * 100 && gain_val * 100 < (533 * 16) )
                                                    {
                                                      sensor_write (sd, 0x3060, 0x0024);
                                                      dig_gain = gain_val * 12800 / (457 * 16);
                                                    }
                                                    else
                                                      if ( (533 * 16) <= gain_val * 100 && gain_val * 100 < (640 * 16) )
                                                      {
                                                        sensor_write (sd, 0x3060, 0x0028);
                                                        dig_gain = gain_val * 12800 / (533 * 16);
                                                      }
                                                      else
                                                        if ( (640 * 16) <= gain_val * 100 && gain_val * 100 < (800 * 16) )
                                                        {
                                                          sensor_write (sd, 0x3060, 0x002c);
                                                          dig_gain = gain_val * 12800 / (640 * 16);
                                                        }
                                                        else
                                                          if ( (800 * 16) <= gain_val * 100 )
                                                          {
