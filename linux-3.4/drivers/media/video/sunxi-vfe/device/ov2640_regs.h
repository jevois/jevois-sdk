...
#define REG_C7 0xc7
#define	  AWB_OFF            0x40
#define	  AWB_SIMPLE         0x10
#define	  AWB_ON             0x00	(Advanced AWB ?) */
#define REG_RED     0xcc  /* JEVOIS: undocumented register */
#define REG_GREEN   0xcd  /* JEVOIS: undocumented register */
#define REG_BLUE    0xce  /* JEVOIS: undocumented register */
#define R_DVP_SP    0xD3 /* DVP output speed control */
#define   R_DVP_SP_AUTO_MODE 0x80
#define   R_DVP_SP_DVP_MASK  0x3F /* DVP PCLK = sysclk (48)/[6:0] (YUV0) or = sysclk (48)/(2*[6:0]) (RAW) */
...
#define   IMAGE_MODE_HREF_VSYNC  0x02 /* HREF timing select in DVP JPEG output mode (0 for HREF is same as sensor) */
#define   IMAGE_MODE_LBYTE_FIRST 0x01 /* Byte swap enable for DVP
                                       *    1: Low byte first UYVY (C2[4] =0) or VYUY (C2[4] =1)
                                       *    0: High byte first YUYV (C2[4]=0) or YVYU (C2[4] = 1) */
...
#define   COM10_PCLK_RISE      0x10 /* Data is updated at the rising edge of PCLK (user can latch data at the next
                                     * falling edge of PCLK). 0 otherwise. */
