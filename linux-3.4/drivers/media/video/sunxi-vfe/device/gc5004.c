...
static int sensor_s_gain (struct v4l2_subdev * sd, int gain_val)
{
  ...
  { gain_val = 0x40; }
    ...
    if ( (ANALOG_GAIN_1 <= gain_val) && (gain_val < ANALOG_GAIN_2) )
    {
      ...
      if ( (ANALOG_GAIN_2 <= gain_val) && (gain_val < ANALOG_GAIN_3) )
      {
        ...
        if ( (ANALOG_GAIN_3 <= gain_val) && (gain_val < ANALOG_GAIN_4) )
        {
          ...
          if ( (ANALOG_GAIN_4 <= gain_val) && (gain_val < ANALOG_GAIN_5) )
          {
