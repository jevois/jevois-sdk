    ...
    if (intstat[i]) {
      ...
      for (bit = 0; bit < 32; bit++) {
        ...
        if (intid == dev->intfdesc.bInterruptId) {
          ...
          if (intid == porta->hwcfg.interruptid) {
            ...
            if (intid == portb->hwcfg.interruptid) {
              ...
              if (intid == portc->hwcfg.interruptid) {
                ...
                if (intid == portd->hwcfg.interruptid) {
                  ...
                  if (intid == porte->hwcfg.interruptid) {
                    ...
                    if (intid == portf->hwcfg.interruptid) {
