...
static int mt2060_set_params (struct dvb_frontend * fe)
{
  ...
  if (freq <=  95000) { lnaband = 0xB0; }
    ...
    if (freq <= 180000) { lnaband = 0xA0; }
    else
      if (freq <= 260000) { lnaband = 0x90; }
      else
        if (freq <= 335000) { lnaband = 0x80; }
        else
          if (freq <= 425000) { lnaband = 0x70; }
          else
            if (freq <= 480000) { lnaband = 0x60; }
            else
              if (freq <= 570000) { lnaband = 0x50; }
              else
                if (freq <= 645000) { lnaband = 0x40; }
                else
                  if (freq <= 730000) { lnaband = 0x30; }
                  else
                    if (freq <= 810000) { lnaband = 0x20; }
                    else { lnaband = 0x10; }
