  ...
  if (0 != av7110->current_input) {
    ...
    case 1:
      ...
      if (av7110->analog_tuner_flags & ANALOG_TUNER_VES1820) {
        ...
        if (av7110->analog_tuner_flags & ANALOG_TUNER_STV0297) {
...
int av7110_init_analog_module (struct av7110 * av7110)
{
  ...
  if (i2c_writereg (av7110, 0x48, 0x01, 0x00) != 1) {
    ...
    if ( (av7110->dev->pci->subsystem_vendor == 0x110a) && (av7110->dev->pci->subsystem_device == 0x0000) ) {
      ...
      if ( (av7110->dev->pci->subsystem_vendor == 0x13c2) && (av7110->dev->pci->subsystem_device == 0x0002) ) {
        /* Hauppauge/TT DVB-C premium */
        av7110->analog_tuner_flags |= ANALOG_TUNER_VES1820;
      }
      else
        if ( (av7110->dev->pci->subsystem_vendor == 0x13c2) && (av7110->dev->pci->subsystem_device == 0x000A) ) {
          /* Hauppauge/TT DVB-C premium */
