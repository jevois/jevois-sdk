                              ...
                              unsigned num_raid_params)
{
  ...
  for (i = 0; i < num_raid_params; i++) {
    ...
    if (!strcasecmp (key, "rebuild") ) {
      ...
      if (!strcasecmp (key, "write_mostly") ) {
        if (rs->raid_type->level != 1) {
        ...
        if (!strcasecmp (key, "max_write_behind") ) {
          if (rs->raid_type->level != 1) {
          ...
          if (!strcasecmp (key, "daemon_sleep") ) {
            ...
            if (!strcasecmp (key, "stripe_cache") ) {
              ...
              if (!strcasecmp (key, "min_recovery_rate") ) {
                ...
                if (!strcasecmp (key, "max_recovery_rate") ) {
