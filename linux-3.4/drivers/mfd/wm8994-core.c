...
static int wm8994_suspend (struct device * dev)
{
  ...
  if (ret < 0) {
    ...
    if (ret & (WM8994_AIF2ADCL_ENA | WM8994_AIF2ADCR_ENA |
  ...
  if (ret < 0) {
    ...
    if (ret & (WM8994_AIF2DACL_ENA | WM8994_AIF2DACR_ENA |
  ...
  case WM1811:
    ...
    if (ret < 0) {
      ...
      if (ret & WM1811_JACKDET_MODE_MASK) {
        dev_dbg (dev, "CODEC still active, ignoring suspend\n");
        return 0;
      }
    break;
