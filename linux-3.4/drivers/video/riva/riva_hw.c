  ...
  while (1)
  {
    ...
    case VIDEO:
      if (last == cur)    { misses = 0; }
        ...
        if (ainfo->first_vacc)   { misses = vmisses; }
        else    { misses = 1; }
      ainfo->first_vacc = 0;
      if (last != cur)
      {
    ...
    case GRAPHICS:
      if (last == cur)    { misses = 0; }
        ...
        if (ainfo->first_gacc)   { misses = gmisses; }
        else    { misses = 1; }
      ainfo->first_gacc = 0;
      if (last != cur)
      {
    ...
    default:
      if (last == cur)    { misses = 0; }
        ...
        if (ainfo->first_macc)   { misses = mmisses; }
        else    { misses = 1; }
      ainfo->first_macc = 0;
      ...
      */
      ...
      if (width == 1) {
        ...
        { clwm = 0xfff; } /*Large number to fail */
          ...
          if (crtc_drain_rate * 100  >= nvclk_fill * 98) {
            clwm = 1024;
            cbs = 512;
