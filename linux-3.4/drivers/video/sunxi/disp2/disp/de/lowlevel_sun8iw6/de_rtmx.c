                          ...
                          unsigned int *size, unsigned int *align, de_3d_in_mode trdinmode, unsigned int *addr, unsigned char *haddr)
{
	...
	else if	 (fmt==DE_FORMAT_YUV422_P)		{ycnt = 1;ucnt=1; x1=x0/2;y1=y0;}
	else if	 (fmt==DE_FORMAT_YUV420_P)		{ycnt = 1;ucnt=1; x1=x0/2;y1=y0/2;}
	else if	 (fmt==DE_FORMAT_YUV411_P)		{ycnt = 1;ucnt=1; x1=x0/4;y1=y0;}
                      ...
                      unsigned int *addr, unsigned int *trd_addr, unsigned int *pitch, unsigned int *pitchr, unsigned int *lay_laddr)
{
	...
	else if	 (fmt==DE_FORMAT_YUV422_P)		{ycnt = 1;data_type=0x2;ucnt=1;}
	else if	 (fmt==DE_FORMAT_YUV420_P)		{ycnt = 1;data_type=0x2;ucnt=1;}
	else if	 (fmt==DE_FORMAT_YUV411_P)		{ycnt = 1;data_type=0x2;ucnt=1;}
...
int de_rtmx_get_lay_size(unsigned int sel, unsigned int chno, unsigned int layno, disp_rectsz*size)
{
	...
	else
	{
		...
		else if	 (fmt==DE_FORMAT_YUV422_P)		{ycnt = 1;ucnt=1;}
		else if	 (fmt==DE_FORMAT_YUV420_P)		{ycnt = 1;ucnt=1;}
		else if	 (fmt==DE_FORMAT_YUV411_P)		{ycnt = 1;ucnt=1;}
