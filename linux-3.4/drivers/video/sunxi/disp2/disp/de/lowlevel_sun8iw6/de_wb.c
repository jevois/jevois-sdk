            ...
            { wb_dev[sel]->fmt.dwval = WB_FORMAT_BGR_888; }
              ...
              { wb_dev[sel]->fmt.dwval = WB_FORMAT_YUV420_P; }
                ...
                { wb_dev[sel]->fmt.dwval = WB_FORMAT_YUV420_SP_UVUV; }
                  ...
                  if (out_fmt == DISP_FORMAT_YUV420_SP_UVUV)
