...
s32 esCLK_reg_cb(s32 nMclkNo, __pCB_ClkCtl_t pCb);
s32  esCLK_unreg_cb(s32 nMclkNo);				
...
s32  esCLK_SetMclkSrc(__hdle hMclk, s32 nSclkNo);
s32  esCLK_GetMclkSrc(__hdle hMclk);				
