...
__u32  csc_tab[192] =
{
  ...
  0x0400, 0x0000, 0x0000, 0x0000, 0x0000, 0x0400, 0x0000, 0x0000, 0x0000, 0x0000, 0x0400, 0x0000,
  0x0204, 0x0107, 0x0064, 0x0100, 0x1ed6, 0x1f68, 0x01c2, 0x0800, 0x1e87, 0x01c2, 0x1fb7, 0x0800,
  
  0x04a8, 0x1f26, 0x1ddd, 0x04d0, 0x04a8, 0x0000, 0x072c, 0x307e, 0x04a8, 0x0876, 0x0000, 0x2dea,
  0x0400, 0x0000, 0x0000, 0x0000, 0x0000, 0x0400, 0x0000, 0x0000, 0x0000, 0x0000, 0x0400, 0x0000,
  0x0400, 0x0000, 0x0000, 0x0000, 0x0000, 0x0400, 0x0000, 0x0000, 0x0000, 0x0000, 0x0400, 0x0000,
  0x0275, 0x00bb, 0x003f, 0x0100, 0x1ea6, 0x1f99, 0x01c2, 0x0800, 0x1e67, 0x01c2, 0x1fd7, 0x0800,
  
  0x0400, 0x1e9e, 0x1d24, 0x087b, 0x0400, 0x0000, 0x059c, 0x34c8, 0x0400, 0x0716, 0x0000, 0x31d5,
  0x0400, 0x0000, 0x0000, 0x0000, 0x0000, 0x0400, 0x0000, 0x0000, 0x0000, 0x0000, 0x0400, 0x0000,
  0x0400, 0x0000, 0x0000, 0x0000, 0x0000, 0x0400, 0x0000, 0x0000, 0x0000, 0x0000, 0x0400, 0x0000,
  0x0259, 0x0132, 0x0075, 0x0000, 0x1ead, 0x1f53, 0x0200, 0x0800, 0x1e54, 0x0200, 0x1fac, 0x0800,
...
{
  DE_BE_WUINT32 (sel, DE_BE_MODE_CTL_OFF, DE_BE_RUINT32 (sel, DE_BE_MODE_CTL_OFF) | (0x01 << 1) );
  DE_BE_WUINT32 (sel, DE_BE_MODE_CTL_OFF, DE_BE_RUINT32 (sel, DE_BE_MODE_CTL_OFF) | 0x01);
...
{
  DE_BE_WUINT32 (sel, DE_BE_MODE_CTL_OFF, DE_BE_RUINT32 (sel, DE_BE_MODE_CTL_OFF) & 0xfffffffd);
  DE_BE_WUINT32 (sel, DE_BE_MODE_CTL_OFF, DE_BE_RUINT32 (sel, DE_BE_MODE_CTL_OFF) & 0xfffffffe);
...
__s32 DE_BE_Output_Select (__u32 sel, __u32 out_sel)
{
  ...
  DE_BE_WUINT32 (sel, DE_BE_MODE_CTL_OFF, (DE_BE_RUINT32 (sel, DE_BE_MODE_CTL_OFF) & 0xff8fffff) | (out_sel << 20) );
...
__s32 DE_BE_Set_Enhance_ex (__u8 sel, __u32 out_csc, __u32 out_color_range, __u32 enhance_en, __u32 brightness, __u32 contrast, __u32 saturaion, __u32 hue)
{
  ...
  if (out_csc == 0)
  {
    if (enhance_en == 1)
    {
      for (i = 0; i < 16; i++)
      {
        * ( (__s64 *) (&tmpcoeff.x00) + i) = ( (__s64) * (image_enhance_tab + 0x20 + i) << 32 ) >> 32;
      }
      ...
      for (i = 0; i < 16; i++)
      {
        * ( (__s64 *) (&tmpcoeff.x00) + i) = ( (__s64) * (image_enhance_tab + 0x30 + i) << 32) >> 32;
      }
    ...
    if (out_csc == 1)
    {
      for (i = 0; i < 16; i++)
      {
        * ( (__s64 *) (&tmpcoeff.x00) + i)  = ( (__s64) * (image_enhance_tab + i) << 32) >> 32;
      }
      ...
      else
      {
        for (i = 0; i < 16; i++)
        {
          * ( (__s64 *) (&tmpcoeff.x00) + i)  = ( (__s64) * (image_enhance_tab + 0x60 + i) << 32) >> 32;
        }
