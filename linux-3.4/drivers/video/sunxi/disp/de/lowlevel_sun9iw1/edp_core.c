...
static struct tx_current rbr_tbl[] =
{
  ...
  {0xffff, 0x1f1f1f1f, 0xbbbb, 0x0a0a0a0a, 0x0000},
  {0xffff, 0x1f1f1f1f, 0xbbbb, 0x0a0a0a0a, 0x0000},
  {0xffff, 0x1f1f1f1f, 0xbbbb, 0x00000000, 0x0000},
  {0xffff, 0x1f1f1f1f, 0xbbbb, 0x00000000, 0x0000},
  {0xffff, 0x1f1f1f1f, 0xbbbb, 0x00000000, 0x0000},
  {0xffff, 0x1f1f1f1f, 0xbbbb, 0x00000000, 0x0000},
};
...
static struct tx_current hbr_tbl[] =
{
  ...
  {0xffff, 0x1f1f1f1f, 0xffff, 0x0d0d0d0d, 0x0000},
  {0xffff, 0x1f1f1f1f, 0xffff, 0x0d0d0d0d, 0x0000},
  {0xffff, 0x1f1f1f1f, 0xffff, 0x04040404, 0x0000},
  {0xffff, 0x1f1f1f1f, 0xffff, 0x04040404, 0x0000},
  {0xffff, 0x1f1f1f1f, 0xffff, 0x04040404, 0x0000},
  {0xffff, 0x1f1f1f1f, 0xffff, 0x04040404, 0x0000},
};
...
static int phy_pll_set (unsigned int bit_rate)
{
  if (bit_rate == 5400)
  {
    EDP_WUINT32 (ana_pllbus0, (0xe << 28) + (1 << 25) + (1 << 24) + (2 << 16) + (2 << 11) + (4 << 8) + (0x5a << 0) );
  }
  else
    if (bit_rate == 2700)
    {
      EDP_WUINT32 (ana_pllbus0, (0xe << 28) + (1 << 25) + (1 << 24) + (2 << 16) + (2 << 11) + (4 << 8) + (0x2d << 0) );
    }
    else
    {
      EDP_WUINT32 (ana_pllbus0, (0xe << 28) + (1 << 25) + (0 << 24) + (2 << 16) + (2 << 11) + (4 << 8) + (0x2d << 0) );
    }
...
int dp_sink_init()
{
  ...
  fp_tx_buf[0] = 0x01;
  ret = aux_wr (0x00600, 1, fp_tx_buf);  
  if (ret == -1)
  { return ret; }
  ...
  ret = aux_wr (0x00100, 1, fp_tx_buf);    
  if (ret == -1)
  { return ret; }
  ...
  ret = aux_wr (0x00101, 1, fp_tx_buf);    
  if (ret == -1)
  { return ret; }
...
static int dp_tps1_test (unsigned int swing_lv, unsigned int pre_lv, unsigned int postcur2_lv,
                         unsigned char is_swing_max, unsigned char is_pre_max)           
{
  unsigned int to_cnt;
  int ret;
  ...
  while (1)
  {
    ...
    edp_delay_ms (30);
    edp_delay_ms (training_aux_rd_interval); 
