  ...
  case VIDIOC_QUERYCTRL:
    {
      ...
      if (!minfo->outputs[1].output) {
        ...
        if (minfo->outputs[1].output->getqueryctrl) {
  ...
  case VIDIOC_G_CTRL:
    {
      ...
      if (!minfo->outputs[1].output) {
        ...
        if (minfo->outputs[1].output->getctrl) {
  ...
  case VIDIOC_S_CTRL:
    {
      ...
      if (!minfo->outputs[1].output) {
        ...
        if (minfo->outputs[1].output->setctrl) {
                                          ...
                                          if (!strncmp (this_opt, "dfp:", 4) ) {
                                            ...
                                            if (!strncmp (this_opt, "vmode:", 6) ) {
                                              ...
                                              if (!strncmp (this_opt, "cmode:", 6) ) {
                                                ...
                                                if (!strcmp (this_opt, "disabled") ) /* nodisabled does not exist */
                                                { disabled = 1; }
                                                else
                                                  if (!strcmp (this_opt, "enabled") ) /* noenabled does not exist */
                                                  { disabled = 0; }
                                                  else
                                                    if (!strcmp (this_opt, "sgram") ) /* nosgram == sdram */
                                                    { sgram = 1; }
                                                    else
                                                      if (!strcmp (this_opt, "sdram") )
                                                      { sgram = 0; }
                                                      else
                                                        if (!strncmp (this_opt, "memtype:", 8) )
                                                        { memtype = simple_strtoul (this_opt + 8, NULL, 0); }
                                                          ...
                                                          { inverse = value; }
                                                            ...
                                                            if (!strcmp (this_opt, "accel") )
                                                            { noaccel = !value; }
                                                            else
                                                              if (!strcmp (this_opt, "pan") )
                                                              { nopan = !value; }
                                                              else
                                                                if (!strcmp (this_opt, "pciretry") )
                                                                { no_pci_retry = !value; }
                                                                else
                                                                  if (!strcmp (this_opt, "vga") )
                                                                  { novga = !value; }
                                                                  else
                                                                    if (!strcmp (this_opt, "bios") )
                                                                    { nobios = !value; }
                                                                    else
                                                                      if (!strcmp (this_opt, "init") )
                                                                      { noinit = !value; }
                                                          #ifdef CONFIG_MTRR
                                                                      else
                                                                        if (!strcmp (this_opt, "mtrr") )
                                                                        { mtrr = value; }
                                                          #endif
                                                                        else
                                                                          if (!strcmp (this_opt, "inv24") )
                                                                          { inv24 = value; }
                                                                          else
                                                                            if (!strcmp (this_opt, "cross4MB") )
                                                                            { cross4MB = value; }
                                                                            else
                                                                              if (!strcmp (this_opt, "grayscale") )
                                                                              { grayscale = value; }
                                                                              else
                                                                                if (!strcmp (this_opt, "dfp") )
                                                                                { dfp = value; }
                                                                                else {
