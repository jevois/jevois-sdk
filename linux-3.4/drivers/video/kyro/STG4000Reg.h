...
typedef struct {
  ...
  /*
     volatile u32 Fill4[0x0400/4 - 0x0190/4];
     volatile u32 Fill5[0x05FC/4 - 0x0400/4];
     volatile u32 Fill6[0x0604/4 - 0x0600/4];
     volatile u32 Fill7[0x0680/4 - 0x0608/4];
     volatile u32 Fill8[0x07FC/4 - 0x0684/4];
   */
  ...
  /*
     volatile u32 Fill11[0x0CBC/4 - 0x0C94/4];
     volatile u32 Fill12[0x0CD0/4 - 0x0CC0/4];
   */
  ...
  /*
     volatile u32 Fill11[0x1FFC/4 - 0x1708/4];
     volatile u32 Fill17[0x3000/4 - 0x2FFC/4];
   */
