                    ...
                    if (!strncmp (this_opt, "hsync:", 6) ) {
                      ...
                      if (!strncmp (this_opt, "vsync:", 6) ) {
                        ...
                        if (!strncmp (this_opt, "dpc:", 4) ) {
                          ...
                          if (!strncmp (this_opt, "outputen:", 9) ) {
                            ...
                            if (!strncmp (this_opt, "pixclockpol:", 12) ) {
                              ...
                              if (!strncmp (this_opt, "color", 5) ) {
                                inf->lccr0 = (inf->lccr0 & ~LCCR0_CMS) | LCCR0_Color;
                              }
                              else
                                if (!strncmp (this_opt, "mono", 4) ) {
                                  ...
                                  if (!strncmp (this_opt, "active", 6) ) {
                                    ...
                                    if (!strncmp (this_opt, "passive", 7) ) {
                                      inf->lccr0 = (inf->lccr0 & ~LCCR0_PAS) | LCCR0_Pas;
                                    }
                                    else
                                      if (!strncmp (this_opt, "single", 6) ) {
                                        inf->lccr0 = (inf->lccr0 & ~LCCR0_SDS) | LCCR0_Sngl;
                                      }
                                      else
                                        if (!strncmp (this_opt, "dual", 4) ) {
                                          inf->lccr0 = (inf->lccr0 & ~LCCR0_SDS) | LCCR0_Dual;
                                        }
                                        else
                                          if (!strncmp (this_opt, "4pix", 4) ) {
                                            inf->lccr0 = (inf->lccr0 & ~LCCR0_DPD) | LCCR0_4PixMono;
                                          }
                                          else
                                            if (!strncmp (this_opt, "8pix", 4) ) {
