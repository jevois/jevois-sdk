    ...
    int pwm_fan)
{
  ...
  { fct->ctrl.name = "cpu-rear-fan-0"; }
    ...
    if (!strcmp (l, "Rear Fan 1") || !strcmp (l, "Rear fan 1") ||
        !strcmp (l, "CPU B EXHAUST") )
    { fct->ctrl.name = "cpu-rear-fan-1"; }
    else
      if (!strcmp (l, "Front Fan 0") || !strcmp (l, "Front Fan") ||
          !strcmp (l, "Front fan 0") || !strcmp (l, "Front fan") ||
          !strcmp (l, "CPU A INTAKE") )
      { fct->ctrl.name = "cpu-front-fan-0"; }
      else
        if (!strcmp (l, "Front Fan 1") || !strcmp (l, "Front fan 1") ||
            !strcmp (l, "CPU B INTAKE") )
        { fct->ctrl.name = "cpu-front-fan-1"; }
        else
          if (!strcmp (l, "CPU A PUMP") )
          { fct->ctrl.name = "cpu-pump-0"; }
          else
            if (!strcmp (l, "CPU B PUMP") )
            { fct->ctrl.name = "cpu-pump-1"; }
            else
              if (!strcmp (l, "Slots Fan") || !strcmp (l, "Slots fan") ||
                  !strcmp (l, "EXPANSION SLOTS INTAKE") )
              { fct->ctrl.name = "slots-fan"; }
              else
                if (!strcmp (l, "Drive Bay") || !strcmp (l, "Drive bay") ||
                    !strcmp (l, "DRIVE BAY A INTAKE") )
                { fct->ctrl.name = "drive-bay-fan"; }
                else
                  if (!strcmp (l, "BACKSIDE") )
  ...
  { fct->ctrl.name = "system-fan"; }
    ...
    if (!strcmp (l, "CPU Fan") || !strcmp (l, "CPU fan") )
    { fct->ctrl.name = "cpu-fan"; }
    else
      if (!strcmp (l, "Hard Drive") || !strcmp (l, "Hard drive") )
      { fct->ctrl.name = "drive-bay-fan"; }
      else
        if (!strcmp (l, "HDD Fan") ) /* seen on iMac G5 iSight */
        { fct->ctrl.name = "hard-drive-fan"; }
        else
          if (!strcmp (l, "ODD Fan") ) /* same */
