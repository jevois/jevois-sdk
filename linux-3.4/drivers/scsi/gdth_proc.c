                              ...
                              int length, gdth_ha_str * ha)
{
  ...
  if (length >= 7 && strncmp (buffer, "wbp_off", 7) == 0) {
    ...
    if (length >= 6 && strncmp (buffer, "wbp_on", 6) == 0) {
      buffer += 7;
      length -= 7;
      ...
      if (length >= 6 && strncmp (buffer, "wb_off", 6) == 0) {
        buffer += 7;
        length -= 7;
        ...
        if (length >= 5 && strncmp (buffer, "wb_on", 5) == 0) {
          buffer += 6;
          length -= 6;
          ...
          { strcpy (hrec, "build"); }
            ...
            { strcpy (hrec, "ready"); }
              ...
              { strcpy (hrec, "fail"); }
                ...
                if (pai->ai_state == 8 || pai->ai_state == 10)
                { strcpy (hrec, "rebuild"); }
                else
                { strcpy (hrec, "error"); }
