...
qla2x00_ga_nxt (scsi_qla_host_t * vha, fc_port_t * fcport)
{
  ...
  if (rval != QLA_SUCCESS) {
    ...
    if (qla2x00_chk_ms_status (vha, ms_pkt, ct_rsp, "GA_NXT") !=
        QLA_SUCCESS) {
      rval = QLA_FUNCTION_FAILED;
    }
    else {
...
qla2x00_gid_pt (scsi_qla_host_t * vha, sw_info_t * list)
{
  ...
  if (rval != QLA_SUCCESS) {
    ...
    if (qla2x00_chk_ms_status (vha, ms_pkt, ct_rsp, "GID_PT") !=
        QLA_SUCCESS) {
      rval = QLA_FUNCTION_FAILED;
    }
    else {
...
qla2x00_gpn_id (scsi_qla_host_t * vha, sw_info_t * list)
{
  ...
  for (i = 0; i < ha->max_fibre_devices; i++) {
    ...
    if (rval != QLA_SUCCESS) {
      ...
      if (qla2x00_chk_ms_status (vha, ms_pkt, ct_rsp,
                                 "GPN_ID") != QLA_SUCCESS) {
        rval = QLA_FUNCTION_FAILED;
        break;
      }
...
qla2x00_rft_id (scsi_qla_host_t * vha)
{
  ...
  if (rval != QLA_SUCCESS) {
    ...
    if (qla2x00_chk_ms_status (vha, ms_pkt, ct_rsp, "RFT_ID") !=
        QLA_SUCCESS) {
      rval = QLA_FUNCTION_FAILED;
    }
    else {
...
qla2x00_rff_id (scsi_qla_host_t * vha)
{
  ...
  if (rval != QLA_SUCCESS) {
    ...
    if (qla2x00_chk_ms_status (vha, ms_pkt, ct_rsp, "RFF_ID") !=
        QLA_SUCCESS) {
      rval = QLA_FUNCTION_FAILED;
    }
    else {
...
qla2x00_rnn_id (scsi_qla_host_t * vha)
{
  ...
  if (rval != QLA_SUCCESS) {
    ...
    if (qla2x00_chk_ms_status (vha, ms_pkt, ct_rsp, "RNN_ID") !=
        QLA_SUCCESS) {
      rval = QLA_FUNCTION_FAILED;
    }
    else {
...
qla2x00_rsnn_nn (scsi_qla_host_t * vha)
{
  ...
  if (rval != QLA_SUCCESS) {
    ...
    if (qla2x00_chk_ms_status (vha, ms_pkt, ct_rsp, "RSNN_NN") !=
        QLA_SUCCESS) {
      rval = QLA_FUNCTION_FAILED;
    }
    else {
...
qla2x00_fdmi_rhba (scsi_qla_host_t * vha)
{
  ...
  if (rval != QLA_SUCCESS) {
    ...
    if (qla2x00_chk_ms_status (vha, ms_pkt, ct_rsp, "RHBA") !=
        QLA_SUCCESS) {
      rval = QLA_FUNCTION_FAILED;
...
qla2x00_fdmi_dhba (scsi_qla_host_t * vha)
{
  ...
  if (rval != QLA_SUCCESS) {
    ...
    if (qla2x00_chk_ms_status (vha, ms_pkt, ct_rsp, "DHBA") !=
        QLA_SUCCESS) {
      rval = QLA_FUNCTION_FAILED;
    }
    else {
...
qla2x00_fdmi_rpa (scsi_qla_host_t * vha)
{
  ...
  if (rval != QLA_SUCCESS) {
    ...
    if (qla2x00_chk_ms_status (vha, ms_pkt, ct_rsp, "RPA") !=
        QLA_SUCCESS) {
      rval = QLA_FUNCTION_FAILED;
    }
    else {
...
qla2x00_gpsc (scsi_qla_host_t * vha, sw_info_t * list)
{
  ...
  for (i = 0; i < ha->max_fibre_devices; i++) {
    ...
    if (rval != QLA_SUCCESS) {
      ...
      if ( (rval = qla2x00_chk_ms_status (vha, ms_pkt, ct_rsp,
                                          "GPSC") ) != QLA_SUCCESS) {
