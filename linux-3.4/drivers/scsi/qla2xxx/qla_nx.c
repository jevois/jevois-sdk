...
qla82xx_pci_set_window (struct qla_hw_data * ha, unsigned long long addr)
{
  ...
  if (QLA82XX_ADDR_IN_RANGE (addr, QLA82XX_ADDR_DDR_NET,
    ...
    if (QLA82XX_ADDR_IN_RANGE (addr, QLA82XX_ADDR_OCM0,
      ...
      if (QLA82XX_ADDR_IN_RANGE (addr, QLA82XX_ADDR_QDR_NET,
                                       ...
                                       unsigned long long addr)
{
  ...
  { BUG(); }
    ...
    { return 1; }
      ...
      if (QLA82XX_ADDR_IN_RANGE (addr, QLA82XX_ADDR_OCM1,
                                 QLA82XX_ADDR_OCM1_MAX) )
      { return 1; }
      else
        if (QLA82XX_ADDR_IN_RANGE (addr, QLA82XX_ADDR_QDR_NET, qdr_max) ) {
          /* QDR network side */
    ...
    if (p_mask) {
      ...
      do {
        ...
        { break; }
          ...
          if (time_after_eq (jiffies, w_time) ) {
            /* capturing dump failed */
