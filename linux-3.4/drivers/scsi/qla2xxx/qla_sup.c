...
qla83xx_beacon_blink (struct scsi_qla_host * vha)
{
  ...
  if (IS_QLA2031 (ha) && ha->beacon_blink_led) {
    ...
    if ( (IS_QLA8031 (ha) || IS_QLA81XX (ha) ) && ha->beacon_blink_led) {
      int rval;
    ...
    case 0x01: /* AMD flash. */
      if (flash_id == 0x38 || flash_id == 0x40 ||
        ...
        if (flash_id == 0x3e) {
          ...
          if (flash_id == 0x20 || flash_id == 0x6e) {
            /*
