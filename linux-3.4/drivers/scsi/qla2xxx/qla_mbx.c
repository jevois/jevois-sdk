                      ...
                      uint8_t area, uint8_t al_pa, uint16_t * mb, uint8_t opt)
{
  ...
  if (rval != QLA_SUCCESS) {
    ...
    if (lg->entry_status != 0) {
      ...
      if (lg->comp_status != __constant_cpu_to_le16 (CS_COMPLETE) ) {
  ...
  if (rval != QLA_SUCCESS) {
    ...
    if (sts->entry_status != 0) {
      ...
      if (sts->comp_status !=
        ...
        if (le16_to_cpu (sts->scsi_status) &
...
qla24xx_modify_vp_config (scsi_qla_host_t * vha)
{
  ...
  if (rval != QLA_SUCCESS) {
    ...
    if (vpmod->comp_status != 0) {
      ...
      if (vpmod->comp_status != __constant_cpu_to_le16 (CS_COMPLETE) ) {
...
qla24xx_control_vp (scsi_qla_host_t * vha, int cmd)
{
  ...
  if (rval != QLA_SUCCESS) {
    ...
    if (vce->entry_status != 0) {
      ...
      if (vce->comp_status != __constant_cpu_to_le16 (CS_COMPLETE) ) {
