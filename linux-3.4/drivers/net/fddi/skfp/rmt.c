  ...
  case RM2_RING_OP :
    ...
    /*RM22a*/
      ...
      /*RM25*/
        ...
        if (smc->r.dup_addr_test == DA_FAILED) {
          smc->mib.m[MAC0].fddiMACMA_UnitdataAvailable = FALSE ;
          smc->r.loop_avail = FALSE ;
          smc->r.da_flag = TRUE ;
  ...
  case RM3_DETECT :
    ...
    /*RM33a*/
      ...
      /*RM33b*/
        ...
        if (cmd == RM_TRT_EXP && !smc->r.bn_flag) {
          int tx ;
          /*
        ...
        /*RM34a*/
          ...
          if (cmd == RM_MY_CLAIM && smc->r.timer0_exp) {
          ...
          /*RM34b*/
            ...
            if (cmd == RM_MY_BEACON && smc->r.timer0_exp) {
              rmt_new_dup_actions (smc) ;
              GO_STATE (RM4_NON_OP_DUP) ;
              break ;
            }
    ...
    /*RM44a*/
      ...
      /*RM44b*/
        ...
        /*RM44c*/
          ...
          if (cmd == RM_TIMEOUT_ANNOUNCE && !smc->r.bn_flag) {
            rmt_dup_actions (smc) ;
          }
          /*RM45*/
          else
