    ...
    if (!strcmp (phy_prop, "xgf") ) {
      ...
      if (!strcmp (phy_prop, "pcs") ) {
        ...
        if (!strcmp (phy_prop, "xgc") ) {
          ...
          if (!strcmp (phy_prop, "xgsd") || !strcmp (phy_prop, "gsd") ) {
...
static int niu_pci_vpd_get_nports (struct niu * np)
{
  ...
  if ( (!strcmp (np->vpd.model, NIU_QGC_LP_MDL_STR) ) ||
    ...
    if ( (!strcmp (np->vpd.model, NIU_2XGF_LP_MDL_STR) ) ||
...
static void __devinit niu_pci_vpd_validate (struct niu * np)
{
  ...
  if (!strcmp (np->vpd.model, NIU_ALONSO_MDL_STR) ||
    ...
    if (!strcmp (np->vpd.model, NIU_FOXXY_MDL_STR) ) {
