...
s32 e1000_setup_link (struct e1000_hw * hw)
{
  ...
  if (hw->fc == E1000_FC_DEFAULT) {
    ...
    { hw->fc = E1000_FC_NONE; }
      ...
      if ( (eeprom_data & EEPROM_WORD0F_PAUSE_MASK) ==
       ...
       */
         ...
         */
           ...
           */
            ...
            if ( (hw->original_fc == E1000_FC_NONE ||
                                   ...
                                   struct e1000_phy_info * phy_info)
{
  ...
  if ( (phy_data & IGP01E1000_PSSR_SPEED_MASK) ==
    ...
    { phy_info->cable_length = e1000_cable_length_50; }
      ...
      if (average <= e1000_igp_cable_length_80)
      { phy_info->cable_length = e1000_cable_length_50_80; }
      else
        if (average <= e1000_igp_cable_length_110)
        { phy_info->cable_length = e1000_cable_length_80_110; }
        else
          if (average <= e1000_igp_cable_length_140)
...
static void e1000_release_eeprom (struct e1000_hw * hw)
{
  ...
  if (hw->eeprom.type == e1000_eeprom_spi) {
    ...
    if (hw->eeprom.type == e1000_eeprom_microwire) {
      /* cleanup eeprom */
                                   ...
                                   u16 * max_length)
{
  ...
  *min_length = *max_length = 0;
  ...
  if (hw->phy_type == e1000_phy_m88) {
    ...
    if (hw->phy_type == e1000_phy_igp) { /* For IGP PHY */
      u16 cur_agc_value;
...
static s32 e1000_set_d3_lplu_state (struct e1000_hw * hw, bool active)
{
  ...
  if (!active) {
    ...
    if (hw->smart_speed == e1000_smart_speed_on) {
      ...
      if (hw->smart_speed == e1000_smart_speed_off) {
        ret_val =
          e1000_read_phy_reg (hw, IGP01E1000_PHY_PORT_CONFIG,
                              &phy_data);
        if (ret_val)
    ...
    if ( (hw->autoneg_advertised == AUTONEG_ADVERTISE_SPEED_DEFAULT)
