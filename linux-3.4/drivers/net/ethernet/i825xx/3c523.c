...
elmc_interrupt (int irq, void * dev_id)
{
  ...
  if (!netif_running (dev) ) {
    ...
    if (! (ELMC_CTRL_INT & inb (dev->base_addr + ELMC_CTRL) ) ) {
      /* wasn't this device */
      return IRQ_NONE;
    }
