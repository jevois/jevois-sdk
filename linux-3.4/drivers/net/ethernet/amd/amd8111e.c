...
static int amd8111e_calc_coalesce (struct net_device * dev)
{
  ...
  if (rx_pkt_rate < 800) {
    ...
    if (rx_pkt_size < 128) {
      ...
      if ( (rx_pkt_size >= 128) && (rx_pkt_size < 512) ) {
        ...
        if ( (rx_pkt_size >= 512) && (rx_pkt_size < 1024) ) {
  ...
  if (tx_pkt_rate < 800) {
    ...
    if (tx_pkt_size < 128) {
      ...
      if ( (tx_pkt_size >= 128) && (tx_pkt_size < 512) ) {
        ...
        if ( (tx_pkt_size >= 512) && (tx_pkt_size < 1024) ) {
