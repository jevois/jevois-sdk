...
typedef enum _BT_CTRL_STATUS{
	BT_STATUS_SUCCESS									= 0x00,
	BT_STATUS_BT_OP_SUCCESS 							= 0x01,
	BT_STATUS_H2C_SUCCESS								= 0x02,
	BT_STATUS_H2C_TIMTOUT								= 0x03,
	BT_STATUS_H2C_BT_NO_RSP 							= 0x04,
	BT_STATUS_C2H_SUCCESS								= 0x05,
	BT_STATUS_C2H_REQNUM_MISMATCH						= 0x06,
	BT_STATUS_OPCODE_U_VERSION_MISMATCH 				= 0x07,
	BT_STATUS_OPCODE_L_VERSION_MISMATCH 				= 0x08,
	BT_STATUS_UNKNOWN_OPCODE_U							= 0x09,
	BT_STATUS_UNKNOWN_OPCODE_L							= 0x0a,
	BT_STATUS_PARAMETER_FORMAT_ERROR_U					= 0x0b,
	BT_STATUS_PARAMETER_FORMAT_ERROR_L					= 0x0c,
	BT_STATUS_PARAMETER_OUT_OF_RANGE_U					= 0x0d,
	BT_STATUS_PARAMETER_OUT_OF_RANGE_L					= 0x0e,
	BT_STATUS_UNKNOWN_STATUS_L							= 0x0f,
	BT_STATUS_UNKNOWN_STATUS_H							= 0x10,
	BT_STATUS_WRONG_LEVEL								= 0x11,
	BT_STATUS_MAX
