...
#define NR_XMITBUFF	(128)
	...
	#if defined(CONFIG_PLATFORM_ARM_SUNxI) || defined(CONFIG_PLATFORM_ARM_SUN6I) || defined(CONFIG_PLATFORM_ARM_SUN7I) || defined(CONFIG_PLATFORM_ARM_SUN8I) || defined(CONFIG_PLATFORM_ARM_SUN9I)
		#define MAX_XMITBUF_SZ (12288) 
	#elif defined (CONFIG_PLATFORM_MSTAR)
		#define MAX_XMITBUF_SZ	7680
	#else
	#define MAX_XMITBUF_SZ	(20480)
	#endif
#else
