...
#ifdef CONFIG_TDLS
/* TDLS STA state */
#define	TDLS_STATE_NONE				0x00000000
...
#define	TDLS_PEER_AT_OFF_STATE		0x02000000
#define	TDLS_AT_OFF_CH_STATE			0x04000000
#define	TDLS_CH_SW_INITIATOR_STATE	0x08000000
#define	TDLS_APSD_CHSW_STATE		0x00100000
#define	TDLS_PEER_SLEEP_STATE		0x00200000
#define	TDLS_SW_OFF_STATE			0x00400000
#define	TDLS_ALIVE_STATE				0x00010000
#define	TDLS_WAIT_PTR_STATE			0x00020000
...
#define	TDLS_WATCHDOG_PERIOD		10
#define	TDLS_STAY_TIME				500
...
static u8 TDLS_RSNIE[]={	0x01, 0x00,
						0x00, 0x0f, 0xac, 0x07,
						0x01, 0x00,
						0x00, 0x0f, 0xac, 0x04,
						0x01, 0x00,
...
static u8 TDLS_WMMIE[]={0x00, 0x50, 0xf2, 0x02, 0x00, 0x01, 0x00};

static u8 TDLS_EXT_CAPIE[] = {0x00, 0x00, 0x00, 0x50, 0x20, 0x00, 0x00, 0x00};
