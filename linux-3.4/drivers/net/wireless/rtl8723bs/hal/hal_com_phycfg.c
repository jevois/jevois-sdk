  ...
  if ( pDM_Odm->PhyRegPgVersion > 0 )
  {
    ...
    if ( pDM_Odm->PhyRegPgVersion == 0 )
    {
      ...
      { pHalData->pwrGroupCnt++; }
        ...
        if ( RegAddr == rTxAGC_B_Mcs15_Mcs12 && pHalData->rf_type != RF_1T1R )
        { pHalData->pwrGroupCnt++; }
    }
    else
        ...
        if ( RateSection == HT_MCS8_MCS15 )
        {
          ...
          if ( RateSection == HT_MCS16_MCS23 )
          {
            ...
            if ( RateSection == HT_MCS24_MCS31 )
            {
              ...
              if ( RateSection == VHT_1SSMCS0_1SSMCS9 )
              {
                ...
                if ( RateSection == VHT_2SSMCS0_2SSMCS9 )
                {
                  ...
                  if ( RateSection == VHT_3SSMCS0_3SSMCS9 )
                  {
                    ...
                    if ( RateSection == VHT_4SSMCS0_4SSMCS9 )
                    {
...
)
{
  ...
  if ( Band == BAND_ON_2_4G ) { band = 0; }
    ...
    if ( Band == BAND_ON_5G ) { band = 1; }
    
  if ( Bandwidth == CHANNEL_WIDTH_20 ) { bandwidth = 0; }
  else
    if ( Bandwidth == CHANNEL_WIDTH_40 ) { bandwidth = 1; }
    else
      if ( Bandwidth == CHANNEL_WIDTH_80 ) { bandwidth = 2; }
      else
        if ( Bandwidth == CHANNEL_WIDTH_160 ) { bandwidth = 3; }
...
)
{
  ...
  if ( eqNByte ( Regulation, (u8 *) ("FCC"), 3 ) ) { regulation = 0; }
    ...
    if ( eqNByte ( Regulation, (u8 *) ("MKK"), 3 ) ) { regulation = 1; }
    else
      if ( eqNByte ( Regulation, (u8 *) ("ETSI"), 4 ) ) { regulation = 2; }
      else
        if ( eqNByte ( Regulation, (u8 *) ("WW13"), 4 ) ) { regulation = 3; }
        
  if ( eqNByte ( RateSection, (u8 *) ("CCK"), 3 ) && eqNByte ( RfPath, (u8 *) ("1T"), 2 ) )
  { rateSection = 0; }
  else
    if ( eqNByte ( RateSection, (u8 *) ("OFDM"), 4 ) && eqNByte ( RfPath, (u8 *) ("1T"), 2 ) )
    { rateSection = 1; }
    else
      if ( eqNByte ( RateSection, (u8 *) ("HT"), 2 ) && eqNByte ( RfPath, (u8 *) ("1T"), 2 ) )
      { rateSection = 2; }
      else
        if ( eqNByte ( RateSection, (u8 *) ("HT"), 2 ) && eqNByte ( RfPath, (u8 *) ("2T"), 2 ) )
        { rateSection = 3; }
        else
          if ( eqNByte ( RateSection, (u8 *) ("HT"), 2 ) && eqNByte ( RfPath, (u8 *) ("3T"), 2 ) )
          { rateSection = 4; }
          else
            if ( eqNByte ( RateSection, (u8 *) ("HT"), 2 ) && eqNByte ( RfPath, (u8 *) ("4T"), 2 ) )
            { rateSection = 5; }
            else
              if ( eqNByte ( RateSection, (u8 *) ("VHT"), 3 ) && eqNByte ( RfPath, (u8 *) ("1T"), 2 ) )
              { rateSection = 6; }
              else
                if ( eqNByte ( RateSection, (u8 *) ("VHT"), 3 ) && eqNByte ( RfPath, (u8 *) ("2T"), 2 ) )
                { rateSection = 7; }
                else
                  if ( eqNByte ( RateSection, (u8 *) ("VHT"), 3 ) && eqNByte ( RfPath, (u8 *) ("3T"), 2 ) )
                  { rateSection = 8; }
                  else
                    if ( eqNByte ( RateSection, (u8 *) ("VHT"), 3 ) && eqNByte ( RfPath, (u8 *) ("4T"), 2 ) )
                    { rateSection = 9; }
                    else
                    {
  ...
  if ( eqNByte ( Bandwidth, (u8 *) ("20M"), 3 ) ) { bandwidth = 0; }
    ...
    if ( eqNByte ( Bandwidth, (u8 *) ("40M"), 3 ) ) { bandwidth = 1; }
    else
      if ( eqNByte ( Bandwidth, (u8 *) ("80M"), 3 ) ) { bandwidth = 2; }
      else
        if ( eqNByte ( Bandwidth, (u8 *) ("160M"), 4 ) ) { bandwidth = 3; }
        ...
        if (GetHexValueFromString (szLine, &u4bRegOffset, &u4bMove) )
        {
          if (u4bRegOffset == 0xffff)
          {
            ...
            if (u4bRegOffset == 0xfe || u4bRegOffset == 0xffe)
            {
              ...
              if (u4bRegOffset == 0xfd)
              {
                rtw_mdelay_os (5);
              }
              else
                if (u4bRegOffset == 0xfc)
                {
                  rtw_mdelay_os (1);
                }
                else
                  if (u4bRegOffset == 0xfb)
                  {
                    rtw_udelay_os (50);
                  }
                  else
                    if (u4bRegOffset == 0xfa)
                    {
                      rtw_udelay_os (5);
                    }
                    else
                      if (u4bRegOffset == 0xf9)
                      {
                        rtw_udelay_os (1);
                      }
    ...
    if (!IsCommentString (szLine) )
    {
      ...
      if ( firstLine )
      {
        ...
        if ( eqNByte ( szLine + 5, (u8 *) ("[Exact]#"), 8 ) )
        {
          ...
          if ( eqNByte ( szLine + 5, (pu1Byte) ("[Relative]#"), 11 ) )
          {
