...
)
{
  ...
  if (TxRate != 0xFF)
  {
    ...
    { PwrTrackingLimit_CCK = 28; } 
      ...
      if ( (TxRate >= MGN_6M) && (TxRate <= MGN_48M) )
      { PwrTrackingLimit_OFDM = 36; }
        ...
        { PwrTrackingLimit_OFDM = 34; }
          ...
          if ( (TxRate >= MGN_MCS0) && (TxRate <= MGN_MCS2) )
          { PwrTrackingLimit_OFDM = 38; }
          else
            if ( (TxRate >= MGN_MCS3) && (TxRate <= MGN_MCS4) )
            { PwrTrackingLimit_OFDM = 36; }
            else
              if ( (TxRate >= MGN_MCS5) && (TxRate <= MGN_MCS7) )
              { PwrTrackingLimit_OFDM = 34; }
