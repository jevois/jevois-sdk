...
)
{
  ...
  u1Byte      OFDM_min_index = 0; 
  u1Byte      Indexforchannel = 0;
  ...
  if (delta > 0 && pDM_Odm->RFCalibrateInfo.TxPowerTrackControl)
  {
    ...
    if (ThermalValue > pDM_Odm->priv->pmib->dot11RFEntry.ther) {
      ...
      pDM_Odm->Absolute_OFDMSwingIdx[ODM_RF_PATH_A] =  deltaSwingTableIdx_TUP_A[delta];       
      ...
      if (c.RfPathCount > 1)
      {
        ...
        pDM_Odm->Absolute_OFDMSwingIdx[ODM_RF_PATH_B] =  deltaSwingTableIdx_TUP_B[delta];      
      ...
      pDM_Odm->Absolute_OFDMSwingIdx[ODM_RF_PATH_A] =  -1 * deltaSwingTableIdx_TDOWN_A[delta];       
    ...
    for (p = ODM_RF_PATH_A; p < c.RfPathCount; p++)
    {
      ...
      if (pDM_Odm->RFCalibrateInfo.OFDM_index[p] > c.SwingTableSize_OFDM - 1)
      {
        ...
        if (pDM_Odm->RFCalibrateInfo.OFDM_index[p] < OFDM_min_index)
        {
