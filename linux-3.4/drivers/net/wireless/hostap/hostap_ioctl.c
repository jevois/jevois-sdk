                                 ...
                                 struct iw_param * rts, char * extra)
{
  ...
  { val = cpu_to_le16 (2346); }
    ...
    if (rts->value < 256 || rts->value > 2346)
    { return -EINVAL; }
    else
...
static void hostap_monitor_set_type (local_info_t * local)
{
  ...
  if (local->monitor_type == PRISM2_MONITOR_PRISM ||
    ...
    if (local->monitor_type == PRISM2_MONITOR_RADIOTAP) {
                                      ...
                                      struct iw_point * erq, char * extra)
{
  ...
  if (*crypt == NULL || (*crypt)->ops == NULL) {
    ...
    { ext->alg = IW_ENCODE_ALG_WEP; }
      ...
      if (strcmp ( (*crypt)->ops->name, "TKIP") == 0)
      { ext->alg = IW_ENCODE_ALG_TKIP; }
      else
        if (strcmp ( (*crypt)->ops->name, "CCMP") == 0)
                                        ...
                                        int param_len)
{
  ...
  if (ops == NULL && strcmp (param->u.crypt.alg, "WEP") == 0) {
    ...
    if (ops == NULL && strcmp (param->u.crypt.alg, "TKIP") == 0) {
      request_module ("lib80211_crypt_tkip");
      ops = lib80211_get_crypto_ops (param->u.crypt.alg);
    }
    else
      if (ops == NULL && strcmp (param->u.crypt.alg, "CCMP") == 0) {
