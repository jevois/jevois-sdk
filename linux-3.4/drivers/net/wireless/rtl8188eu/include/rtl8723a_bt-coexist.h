...
{
  AESCCMP_BLK_SIZE    =   16,    
  AESCCMP_MAX_PACKET    =   4 * 512,
  AESCCMP_N_RESERVED    =   0,     
  AESCCMP_A_DATA      =   0x40,  
  AESCCMP_M_SHIFT     =   3,     
  AESCCMP_L_SHIFT     =   0,     
  AESCCMP_L_SIZE      =   2,      
...
#define MAX_LOGICAL_LINK_NUM      2
#define MAX_BT_ASOC_ENTRY_NUM   2

#define INVALID_PL_HANDLE       0xff
#define INVALID_ENTRY_NUM       0xff

#define CAM_BT_START_INDEX    (HALF_CAM_ENTRY - 4)  
#define BT_HWCAM_STAR       CAM_BT_START_INDEX 
...
typedef enum _BT_STATE_WPA_AUTH
{
  ...
  STATE_WPA_AUTH_WAIT_PACKET_1,
  STATE_WPA_AUTH_WAIT_PACKET_2,
