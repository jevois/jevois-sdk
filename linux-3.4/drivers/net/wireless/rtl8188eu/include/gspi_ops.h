...
#define SPI_REG_TX_CTRL					0x0000
#define SPI_REG_STATUS_RECOVERY		0x0004
#define SPI_REG_INT_TIMEOUT		   	0x0006
#define SPI_REG_HIMR					0x0014
#define SPI_REG_HISR					0x0018
#define SPI_REG_RX0_REQ_LEN			0x001C
#define SPI_REG_FREE_TXPG				0x0020
#define SPI_REG_HCPWM1					0x0024
#define SPI_REG_HCPWM2					0x0026
#define SPI_REG_HTSFR_INFO				0x0030
#define SPI_REG_HRPWM1					0x0080
#define SPI_REG_HRPWM2					0x0082
#define SPI_REG_HPS_CLKR				0x0084
#define SPI_REG_HSUS_CTRL				0x0086
#define SPI_REG_HIMR_ON				0x0090
#define SPI_REG_HISR_ON				0x0091
#define SPI_REG_CFG						0x00F0
