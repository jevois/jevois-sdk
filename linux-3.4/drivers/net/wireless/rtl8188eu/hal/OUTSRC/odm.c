...
{
  {0x5ea42b, 0x5ea42b, 0x5ea42b},
  {0xa44f, 0x5ea44f, 0x5e431c},
  {0x5ea42b, 0x5ea42b, 0x5ea42b},
  {0x5ea32b, 0x5ea42b, 0x5e4322},
  {0x5ea422, 0x00a44f, 0x00a44f},
  {0x5ea322, 0x00a630, 0x00a44f},
  {0x5e4322, 0x5e4322, 0x5e4322},// 6:cisco AP
  {0x5ea44f, 0x00a44f, 0x5ea42b},
  {0x5ea42b, 0x5ea42b, 0x5ea42b},
  {0x5ea42b, 0xa630, 0x5e431c},
};
  ...
  if (pDM_Odm->SupportICType & ODM_IC_11AC_SERIES)
  {
    ...
    if (pDM_Odm->SupportICType & ODM_IC_11N_SERIES)
    {
           ...
           ( pDM_Odm->AntDivType == CG_TRX_SMART_ANTDIV ) )
      {
        ...
        if ( pDM_Odm->AntDivType == CGCS_RX_SW_ANTDIV)
        {
...
)
{
  ...
  */
  ...
  if (pDM_Odm->SupportICType == ODM_RTL8192D)
  {
    if (* (pDM_Odm->pMacPhyMode) == ODM_DMSP)
    {
      ODM_Write_DIG_DMSP (pDM_Odm, CurrentIGI);
      if (* (pDM_Odm->pbMasterOfDMSP) )
      {
...
)
{
  ...
  #endif
  {
    ...
    if ( (ICType != ODM_RTL8192D) && (IOTPeer == HT_IOT_PEER_CISCO) && (WirelessMode == ODM_WM_N24G) )
    {
      ...
      if ( (IOTPeer == HT_IOT_PEER_CISCO) && ( (WirelessMode == ODM_WM_G) || (WirelessMode == ODM_WM_A) || (WirelessMode == ODM_WM_B) ) )
      {
...
)
{
  ...
  psd_cnt++;
  if (psd_cnt < ReScan)
  { PlatformSetTimer ( Adapter, &pHalData->PSDTimer, Interval); }
  else
  { psd_cnt = 0; }
  return;
  #endif
