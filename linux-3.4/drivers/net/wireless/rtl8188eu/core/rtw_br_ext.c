...
static int update_nd_link_layer_addr (unsigned char * data, int len, unsigned char * replace_mac)
{
  ...
  if (icmphdr->icmp6_type == NDISC_ROUTER_SOLICITATION) {
    ...
    if (icmphdr->icmp6_type == NDISC_ROUTER_ADVERTISEMENT) {
      if (len >= 16) {
      ...
      if (icmphdr->icmp6_type == NDISC_NEIGHBOUR_SOLICITATION) {
        if (len >= 24) {
        ...
        if (icmphdr->icmp6_type == NDISC_NEIGHBOUR_ADVERTISEMENT) {
          if (len >= 24) {
          ...
          if (icmphdr->icmp6_type == NDISC_REDIRECT) {
            if (len >= 40) {
  ...
  /*---------------------------------------------------*/
    ...
    /*---------------------------------------------------*/
              ...
              if (*framePtr == snap_8022_type)
              {
                ...
                if (!memcmp (ipx_snap_id, framePtr, 5) )
                {
                  ...
                  if (!memcmp (aarp_snap_id, framePtr, 5) )
                  {
                    ...
                    if (!memcmp (ddp_snap_id, framePtr, 5) )
                    {
                      framePtr += 5; 
      ...
      /*---------------------------------------------------*/
        ...
        if ( (protocol == __constant_htons (ETH_P_PPP_DISC) ) ||
        ...
        /*---------------------------------------------------*/
          ...
          /*---------------------------------------------------*/
            ...
            if ( (protocol == __constant_htons (0xe2ae) ) ||
