  ...
  struct recv_stat * prxstat)
{
  ...
  pattrib->pkt_rpt_type = (u8) ( (report.rxdw3 >> 14) & 0x3);
  
  if (pattrib->pkt_rpt_type == NORMAL_RX)
  {
    pattrib->pkt_len = (u16) (report.rxdw0 & 0x00003fff);
    pattrib->drvinfo_sz = (u8) ( (report.rxdw0 >> 16) & 0xf) * 8;
    
    pattrib->physt =  (u8) ( (report.rxdw0 >> 26) & 0x1);
    
    pattrib->bdecrypted = (report.rxdw0 & BIT (27) ) ? 0 : 1;
    pattrib->encrypt = (u8) ( (report.rxdw0 >> 20) & 0x7);
    
    pattrib->qos = (u8) ( (report.rxdw0 >> 23) & 0x1);
    pattrib->priority = (u8) ( (report.rxdw1 >> 8) & 0xf);
    
    pattrib->amsdu = (u8) ( (report.rxdw1 >> 13) & 0x1);
    
    pattrib->seq_num = (u16) (report.rxdw2 & 0x00000fff);
    pattrib->frag_num = (u8) ( (report.rxdw2 >> 12) & 0xf);
    pattrib->mfrag = (u8) ( (report.rxdw1 >> 27) & 0x1);
    pattrib->mdata = (u8) ( (report.rxdw1 >> 26) & 0x1);
    
    pattrib->mcs_rate = (u8) (report.rxdw3 & 0x3f);
    pattrib->rxht = (u8) ( (report.rxdw3 >> 6) & 0x1);
    
    pattrib->icv_err = (u8) ( (report.rxdw0 >> 15) & 0x1);
    ...
    if (pattrib->pkt_rpt_type == TX_REPORT1)
    {
      ...
      if (pattrib->pkt_rpt_type == TX_REPORT2)
      {
        pattrib->pkt_len = (u16) (report.rxdw0 & 0x3FF);
        pattrib->drvinfo_sz = 0;
        ...
        if (pattrib->pkt_rpt_type == HIS_REPORT)
        {
          pattrib->pkt_len = (u16) (report.rxdw0 & 0x00003fff);
        }
  ...
  struct phy_stat * pphy_status)
{
      ...
      (check_fwstate (&padapter->mlmepriv, WIFI_AP_STATE) == _TRUE) )
  {
    ...
    if (pkt_info.bPacketToSelf || pkt_info.bPacketBeacon)
    {
