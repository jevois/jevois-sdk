...
)
{
  ...
  u4Byte  IQK_BB_REG_92D[IQK_BB_REG_NUM_92D] = { 
    rFPGA0_XAB_RFInterfaceSW, rFPGA0_XA_RFInterfaceOE,
...
)
{
  ...
  if ( (tmpReg & 0x70) != 0) 
  { PlatformEFIOWrite1Byte (pAdapter, 0xd03, tmpReg & 0x8F); }
  else             
  { PlatformEFIOWrite1Byte (pAdapter, REG_TXPAUSE, 0xFF); }    
...
)
{
  ...
  {
    RegE94 = RegEB4 = pHalData->RegE94 = pHalData->RegEB4 = 0x100; 
    RegE9C = RegEBC = pHalData->RegE9C = pHalData->RegEBC = 0x0;   
  }
