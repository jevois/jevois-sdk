...
struct phy_info
{
  u8    RxPWDBAll;
  u8    SignalQuality;  
  u8    RxMIMOSignalQuality[MAX_PATH_NUM_92CS];
...
extern union recv_frame * _rtw_alloc_recvframe (_queue * pfree_recv_queue);
extern union recv_frame * rtw_alloc_recvframe (_queue * pfree_recv_queue);
