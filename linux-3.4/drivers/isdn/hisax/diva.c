...
static int __devinit setup_diva_pci (struct IsdnCard * card)
{
  ...
  if ( (dev_diva = hisax_find_pci_device (PCI_VENDOR_ID_EICON,
    ...
    if ( (dev_diva_u = hisax_find_pci_device (PCI_VENDOR_ID_EICON,
      ...
      if ( (dev_diva201 = hisax_find_pci_device (PCI_VENDOR_ID_EICON,
        ...
        if ( (dev_diva202 = hisax_find_pci_device (PCI_VENDOR_ID_EICON,
